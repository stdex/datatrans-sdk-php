...
class V1AliasesApi
{
     ...
     * Convert alias
     *
     * @param  \Datatrans\Client\Model\AliasConvertRequest $alias_convert_request alias_convert_request (required)
     *
     * @throws \Datatrans\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Datatrans\Client\Model\AliasConvertResponse|\Datatrans\Client\Model\AliasesResponseBase
     */
    public function aliasesConvert($alias_convert_request)
    {
        list($response) = $this->aliasesConvertWithHttpInfo($alias_convert_request);
        return $response;
    }
     ...
     * Convert alias
     *
     * @param  \Datatrans\Client\Model\AliasConvertRequest $alias_convert_request (required)
     *
     * @throws \Datatrans\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Datatrans\Client\Model\AliasConvertResponse|\Datatrans\Client\Model\AliasesResponseBase, HTTP status code, HTTP response headers (array of strings)
     */
    public function aliasesConvertWithHttpInfo($alias_convert_request)
    {
        $request = $this->aliasesConvertRequest($alias_convert_request);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Datatrans\Client\Model\AliasConvertResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Datatrans\Client\Model\AliasConvertResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Datatrans\Client\Model\AliasesResponseBase' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Datatrans\Client\Model\AliasesResponseBase', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Datatrans\Client\Model\AliasConvertResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Datatrans\Client\Model\AliasConvertResponse',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Datatrans\Client\Model\AliasesResponseBase',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     */
    public function aliasesConvertAsync($alias_convert_request)
    {
        return $this->aliasesConvertAsyncWithHttpInfo($alias_convert_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function aliasesConvertAsyncWithHttpInfo($alias_convert_request)
    {
        $returnType = '\Datatrans\Client\Model\AliasConvertResponse';
        $request = $this->aliasesConvertRequest($alias_convert_request);
     ...
     */
    public function aliasesConvertRequest($alias_convert_request)
    {
        // verify the required parameter 'alias_convert_request' is set
        if ($alias_convert_request === null || (is_array($alias_convert_request) && count($alias_convert_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $alias_convert_request when calling aliasesConvert'
            );
        }
        ...
        // for model (json/xml)
        if (isset($alias_convert_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alias_convert_request));
            } else {
                $httpBody = $alias_convert_request;
            }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function aliasesDeleteRequest($alias)
    {
     ...
     * @throws \Datatrans\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Datatrans\Client\Model\AliasInfoResponse|\Datatrans\Client\Model\AliasesResponseBase
     */
     ...
     * @throws \Datatrans\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Datatrans\Client\Model\AliasInfoResponse|\Datatrans\Client\Model\AliasesResponseBase, HTTP status code, HTTP response headers (array of strings)
     */
    public function aliasesInfoWithHttpInfo($alias)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Datatrans\Client\Model\AliasInfoResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Datatrans\Client\Model\AliasInfoResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Datatrans\Client\Model\AliasInfoResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Datatrans\Client\Model\AliasInfoResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function aliasesInfoRequest($alias)
    {
        // verify the required parameter 'alias' is set
        if ($alias === null || (is_array($alias) && count($alias) === 0)) {
            throw new \InvalidArgumentException(
