...
/**
 * V1ReconciliationsApi Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
...
class V1ReconciliationsApi
{
    ...
    /**
     * Operation bulkSaleReport
     *
     * Bulk reporting of sales
     *
     * @param  \Datatrans\Client\Model\BulkSaleReportRequest $bulk_sale_report_request bulk_sale_report_request (required)
     *
     * @throws \Datatrans\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Datatrans\Client\Model\SaleReportResponse
     */
    public function bulkSaleReport($bulk_sale_report_request)
    {
        list($response) = $this->bulkSaleReportWithHttpInfo($bulk_sale_report_request);
        return $response;
    }

    /**
     * Operation bulkSaleReportWithHttpInfo
     *
     * Bulk reporting of sales
     *
     * @param  \Datatrans\Client\Model\BulkSaleReportRequest $bulk_sale_report_request (required)
     *
     * @throws \Datatrans\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Datatrans\Client\Model\SaleReportResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function bulkSaleReportWithHttpInfo($bulk_sale_report_request)
    {
        $request = $this->bulkSaleReportRequest($bulk_sale_report_request);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Datatrans\Client\Model\SaleReportResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Datatrans\Client\Model\SaleReportResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Datatrans\Client\Model\SaleReportResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Datatrans\Client\Model\SaleReportResponse',
     ...
     */
    public function bulkSaleReportAsync($bulk_sale_report_request)
    {
        return $this->bulkSaleReportAsyncWithHttpInfo($bulk_sale_report_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation bulkSaleReportAsyncWithHttpInfo
     *
     * Bulk reporting of sales
     *
     * @param  \Datatrans\Client\Model\BulkSaleReportRequest $bulk_sale_report_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bulkSaleReportAsyncWithHttpInfo($bulk_sale_report_request)
    {
        $returnType = '\Datatrans\Client\Model\SaleReportResponse';
        $request = $this->bulkSaleReportRequest($bulk_sale_report_request);
    ...
    /**
     * Create request for operation 'bulkSaleReport'
     *
     * @param  \Datatrans\Client\Model\BulkSaleReportRequest $bulk_sale_report_request (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function bulkSaleReportRequest($bulk_sale_report_request)
    {
        // verify the required parameter 'bulk_sale_report_request' is set
        if ($bulk_sale_report_request === null || (is_array($bulk_sale_report_request) && count($bulk_sale_report_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $bulk_sale_report_request when calling bulkSaleReport'
            );
        }

        $resourcePath = '/v1/reconciliations/sales/bulk';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($bulk_sale_report_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($bulk_sale_report_request));
            } else {
                $httpBody = $bulk_sale_report_request;
            }
    ...
    /**
     * Operation saleReport
     *
     * Report a sale
     *
     * @param  \Datatrans\Client\Model\SaleReportRequest $sale_report_request sale_report_request (required)
     *
     * @throws \Datatrans\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Datatrans\Client\Model\SaleReportResponse
     */
    public function saleReport($sale_report_request)
    {
        list($response) = $this->saleReportWithHttpInfo($sale_report_request);
        return $response;
    }

    /**
     * Operation saleReportWithHttpInfo
     *
     * Report a sale
     *
     * @param  \Datatrans\Client\Model\SaleReportRequest $sale_report_request (required)
     *
     * @throws \Datatrans\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Datatrans\Client\Model\SaleReportResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function saleReportWithHttpInfo($sale_report_request)
    {
        $request = $this->saleReportRequest($sale_report_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function saleReportAsync($sale_report_request)
    {
        return $this->saleReportAsyncWithHttpInfo($sale_report_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation saleReportAsyncWithHttpInfo
     *
     * Report a sale
     *
     * @param  \Datatrans\Client\Model\SaleReportRequest $sale_report_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function saleReportAsyncWithHttpInfo($sale_report_request)
    {
        $returnType = '\Datatrans\Client\Model\SaleReportResponse';
        $request = $this->saleReportRequest($sale_report_request);
    ...
    /**
     * Create request for operation 'saleReport'
     *
     * @param  \Datatrans\Client\Model\SaleReportRequest $sale_report_request (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function saleReportRequest($sale_report_request)
    {
        // verify the required parameter 'sale_report_request' is set
        if ($sale_report_request === null || (is_array($sale_report_request) && count($sale_report_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sale_report_request when calling saleReport'
            );
        }

        $resourcePath = '/v1/reconciliations/sales';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($sale_report_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($sale_report_request));
            } else {
                $httpBody = $sale_report_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
