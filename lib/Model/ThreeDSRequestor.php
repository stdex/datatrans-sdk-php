...
/**
 * ThreeDSRequestor Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class ThreeDSRequestor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ThreeDSRequestor';
    ...
    protected static $openAPITypes = [
        ...
        'three_ds_requestor_authentication_info' => '\Datatrans\Client\Model\ThreeDSRequestorAuthenticationInformation',
        'three_ds_requestor_challenge_ind' => 'string',
        'three_ds_requestor_dec_req_ind' => 'string',
        'three_ds_requestor_dec_max_time' => 'int'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'three_ds_requestor_dec_max_time' => 'int32'
    ];
    ...
    const THREE_DS_REQUESTOR_AUTHENTICATION_IND__01 = '01';
    const THREE_DS_REQUESTOR_AUTHENTICATION_IND__02 = '02';
    const THREE_DS_REQUESTOR_AUTHENTICATION_IND__03 = '03';
    const THREE_DS_REQUESTOR_AUTHENTICATION_IND__04 = '04';
    const THREE_DS_REQUESTOR_AUTHENTICATION_IND__05 = '05';
    const THREE_DS_REQUESTOR_AUTHENTICATION_IND__06 = '06';
    const THREE_DS_REQUESTOR_CHALLENGE_IND__01 = '01';
    const THREE_DS_REQUESTOR_CHALLENGE_IND__02 = '02';
    const THREE_DS_REQUESTOR_CHALLENGE_IND__03 = '03';
    const THREE_DS_REQUESTOR_CHALLENGE_IND__04 = '04';
    const THREE_DS_REQUESTOR_CHALLENGE_IND__05 = '05';
    const THREE_DS_REQUESTOR_CHALLENGE_IND__06 = '06';
    const THREE_DS_REQUESTOR_CHALLENGE_IND__07 = '07';
    const THREE_DS_REQUESTOR_CHALLENGE_IND__08 = '08';
    const THREE_DS_REQUESTOR_CHALLENGE_IND__09 = '09';
    const THREE_DS_REQUESTOR_DEC_REQ_IND_Y = 'Y';
    const THREE_DS_REQUESTOR_DEC_REQ_IND_N = 'N';
     ...
     * @return string[]
     */
    public function getThreeDsRequestorAuthenticationIndAllowableValues()
    {
        return [
            self::THREE_DS_REQUESTOR_AUTHENTICATION_IND__01,
            self::THREE_DS_REQUESTOR_AUTHENTICATION_IND__02,
            self::THREE_DS_REQUESTOR_AUTHENTICATION_IND__03,
            self::THREE_DS_REQUESTOR_AUTHENTICATION_IND__04,
            self::THREE_DS_REQUESTOR_AUTHENTICATION_IND__05,
            self::THREE_DS_REQUESTOR_AUTHENTICATION_IND__06,
        ];
    }
    ...
    public function getThreeDsRequestorChallengeIndAllowableValues()
    {
        return [
            ...
            self::THREE_DS_REQUESTOR_CHALLENGE_IND__07,
            self::THREE_DS_REQUESTOR_CHALLENGE_IND__08,
            self::THREE_DS_REQUESTOR_CHALLENGE_IND__09,
        ];
    }
    ...
    public function getThreeDsRequestorDecReqIndAllowableValues()
    {
        return [
            ...
            self::THREE_DS_REQUESTOR_DEC_REQ_IND_N,
        ];
    }
    ...
    {
        $this->container['three_ds_requestor_authentication_ind'] = $data['three_ds_requestor_authentication_ind'] ?? null;
        $this->container['three_ds_requestor_authentication_info'] = $data['three_ds_requestor_authentication_info'] ?? null;
        $this->container['three_ds_requestor_challenge_ind'] = $data['three_ds_requestor_challenge_ind'] ?? null;
        $this->container['three_ds_requestor_dec_req_ind'] = $data['three_ds_requestor_dec_req_ind'] ?? null;
        $this->container['three_ds_requestor_dec_max_time'] = $data['three_ds_requestor_dec_max_time'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getThreeDsRequestorAuthenticationIndAllowableValues();
        if (!is_null($this->container['three_ds_requestor_authentication_ind']) && !in_array($this->container['three_ds_requestor_authentication_ind'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'three_ds_requestor_authentication_ind', must be one of '%s'",
                $this->container['three_ds_requestor_authentication_ind'],
     ...
     *
     * @param string|null $three_ds_requestor_authentication_ind three_ds_requestor_authentication_ind
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getThreeDsRequestorAuthenticationIndAllowableValues();
        if (!is_null($three_ds_requestor_authentication_ind) && !in_array($three_ds_requestor_authentication_ind, $allowedValues, true)) {
     ...
     *
     * @return \Datatrans\Client\Model\ThreeDSRequestorAuthenticationInformation|null
     */
     ...
     *
     * @param \Datatrans\Client\Model\ThreeDSRequestorAuthenticationInformation|null $three_ds_requestor_authentication_info three_ds_requestor_authentication_info
     *
     * @return self
     */
     ...
     *
     * @param string|null $three_ds_requestor_challenge_ind three_ds_requestor_challenge_ind
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getThreeDsRequestorChallengeIndAllowableValues();
        if (!is_null($three_ds_requestor_challenge_ind) && !in_array($three_ds_requestor_challenge_ind, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'three_ds_requestor_challenge_ind', must be one of '%s'",
     ...
     *
     * @param string|null $three_ds_requestor_dec_req_ind three_ds_requestor_dec_req_ind
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getThreeDsRequestorDecReqIndAllowableValues();
        if (!is_null($three_ds_requestor_dec_req_ind) && !in_array($three_ds_requestor_dec_req_ind, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'three_ds_requestor_dec_req_ind', must be one of '%s'",
     ...
     *
     * @param int|null $three_ds_requestor_dec_max_time three_ds_requestor_dec_max_time
     *
     * @return self
     */
