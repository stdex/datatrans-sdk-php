...
/**
 * WeChatRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WeChatRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WeChatRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['open_id'] = $data['open_id'] ?? null;
     ...
     * Sets subtype
     *
     * @param string $subtype The WeChat specific payment method used for the transaction.
     *
     * @return self
     */
