...
/**
 * KlarnaDetail Class Doc Comment
 *
 * @category Class
 ...
 */
class KlarnaDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KlarnaDetail';
    ...
    const SUBTYPE_PAY_NOW = 'pay_now';
    const SUBTYPE_PAY_LATER = 'pay_later';
    const SUBTYPE_PAY_OVER_TIME = 'pay_over_time';
    const SUBTYPE_DIRECT_DEBIT = 'direct_debit';
    const SUBTYPE_DIRECT_BANK_TRANSFER = 'direct_bank_transfer';
    ...
    {
        return [
            self::SUBTYPE_PAY_NOW,
            self::SUBTYPE_PAY_LATER,
            self::SUBTYPE_PAY_OVER_TIME,
            self::SUBTYPE_DIRECT_DEBIT,
            self::SUBTYPE_DIRECT_BANK_TRANSFER,
        ];
    }
     ...
     * Sets subtype
     *
     * @param string|null $subtype The Klarna payment subtype.
     *
     * @return self
     */
