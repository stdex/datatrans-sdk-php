 ...
 */
class ESY implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ESY';
     ...
     * Sets description
     *
     * @param string|null $description A description of the purchase.
     *
     * @return self
     */
     ...
     * Sets payment_info
     *
     * @param string|null $payment_info The payment info of the service (also known as billing text). NOTE: The paymentInfo will be placed on the end user invoice bill.
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title The title on top of the Swisscom Pay Payment Page.
     *
     * @return self
     */
