...
/**
 * SecureFieldsInitRequest Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class SecureFieldsInitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecureFieldsInitRequest';
    ...
    protected static $openAPITypes = [
        ...
        'currency' => 'string',
        'return_url' => 'string',
        '_3_d' => '\Datatrans\Client\Model\SecureFieldsThreeDSecure'
    ];
    ...
    public function setCurrency($currency)
    {
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling SecureFieldsInitRequest., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling SecureFieldsInitRequest., must be bigger than or equal to 3.');
        }
     ...
     * Sets return_url
     *
     * @param string $return_url The URL where the browser will be redirected after the 3D authentication process.
     *
     * @return self
     */
     ...
     * Gets _3_d
     *
     * @return \Datatrans\Client\Model\SecureFieldsThreeDSecure|null
     */
     ...
     * Sets _3_d
     *
     * @param \Datatrans\Client\Model\SecureFieldsThreeDSecure|null $_3_d _3_d
     *
     * @return self
     */
