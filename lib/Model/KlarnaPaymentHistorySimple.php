...
/**
 * KlarnaPaymentHistorySimple Class Doc Comment
 *
 * @category Class
 ...
 */
class KlarnaPaymentHistorySimple implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KlarnaPaymentHistorySimple';
