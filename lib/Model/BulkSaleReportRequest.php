...
/**
 * BulkSaleReportRequest Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class BulkSaleReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BulkSaleReportRequest';
    ...
    protected static $openAPITypes = [
        'sales' => '\Datatrans\Client\Model\SaleReportRequest[]'
    ];
     ...
     * Gets sales
     *
     * @return \Datatrans\Client\Model\SaleReportRequest[]|null
     */
     ...
     * Sets sales
     *
     * @param \Datatrans\Client\Model\SaleReportRequest[]|null $sales A list of sale objects.
     *
     * @return self
     */
