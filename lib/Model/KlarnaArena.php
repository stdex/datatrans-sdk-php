 ...
 */
class KlarnaArena implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KlarnaArena';
     ...
     * Sets name
     *
     * @param string|null $name The name of the venue
     *
     * @return self
     */
     ...
     * Sets street
     *
     * @param string|null $street The street of the arena location
     *
     * @return self
     */
     ...
     * Sets zip_code
     *
     * @param string|null $zip_code The postal code of the arena location
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param string|null $city The city of the arena location
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country The country of the arena location
     *
     * @return self
     */
