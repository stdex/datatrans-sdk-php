...
/**
 * AirlineDataRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class AirlineDataRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AirlineDataRequest';
    ...
    protected static $openAPITypes = [
        ...
        'pnr' => 'string',
        'issue_date' => '\DateTime',
        'tickets' => '\Datatrans\Client\Model\Ticket[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['agent_code'] = $data['agent_code'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['agent_code']) && (mb_strlen($this->container['agent_code']) > 8)) {
            $invalidProperties[] = "invalid value for 'agent_code', the character length must be smaller than or equal to 8.";
        }

        if (!is_null($this->container['agent_code']) && (mb_strlen($this->container['agent_code']) < 1)) {
            $invalidProperties[] = "invalid value for 'agent_code', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['pnr']) && (mb_strlen($this->container['pnr']) > 6)) {
            $invalidProperties[] = "invalid value for 'pnr', the character length must be smaller than or equal to 6.";
        }

        if (!is_null($this->container['pnr']) && (mb_strlen($this->container['pnr']) < 1)) {
            $invalidProperties[] = "invalid value for 'pnr', the character length must be bigger than or equal to 1.";
        }
     ...
     * Sets country_code
     *
     * @param string|null $country_code Passenger country code in <a href='https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2' target='_blank'>ISO-3166-1-alpha2</a> format.
     *
     * @return self
     */
     ...
     * Sets agent_code
     *
     * @param string|null $agent_code IATA agency code
     *
     * @return self
     */
    public function setAgentCode($agent_code)
    {
        if (!is_null($agent_code) && (mb_strlen($agent_code) > 8)) {
            throw new \InvalidArgumentException('invalid length for $agent_code when calling AirlineDataRequest., must be smaller than or equal to 8.');
        }
        if (!is_null($agent_code) && (mb_strlen($agent_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $agent_code when calling AirlineDataRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets pnr
     *
     * @param string|null $pnr PNR
     *
     * @return self
     */
    public function setPnr($pnr)
    {
        if (!is_null($pnr) && (mb_strlen($pnr) > 6)) {
            throw new \InvalidArgumentException('invalid length for $pnr when calling AirlineDataRequest., must be smaller than or equal to 6.');
        }
        if (!is_null($pnr) && (mb_strlen($pnr) < 1)) {
            throw new \InvalidArgumentException('invalid length for $pnr when calling AirlineDataRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets issue_date
     *
     * @param \DateTime|null $issue_date Ticket issuing date. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (`YYYY-MM-DD`).
     *
     * @return self
     */
     ...
     * Gets tickets
     *
     * @return \Datatrans\Client\Model\Ticket[]|null
     */
     ...
     * Sets tickets
     *
     * @param \Datatrans\Client\Model\Ticket[]|null $tickets A list of tickets for this purchase. Note: PAP only supports one ticket.
     *
     * @return self
     */
