...
/**
 * AuthorizeSplitError Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class AuthorizeSplitError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthorizeSplitError';
    ...
    protected static $openAPITypes = [
        'code' => '\Datatrans\Client\Model\TransactionsErrorCode',
        'message' => 'string'
    ];
     ...
     * Gets code
     *
     * @return \Datatrans\Client\Model\TransactionsErrorCode|null
     */
     ...
     * Sets code
     *
     * @param \Datatrans\Client\Model\TransactionsErrorCode|null $code code
     *
     * @return self
     */
