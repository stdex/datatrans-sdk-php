...
/**
 * AirlineMetaData Class Doc Comment
 *
 * @category Class
 ...
 */
class AirlineMetaData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AirlineMetaData';
    ...
    protected static $openAPITypes = [
        ...
        'passengers' => '\Datatrans\Client\Model\Passenger'
    ];
    ...
    protected static $setters = [
        ...
        'class_of_travel' => 'setClassOfTravel',
    ...
    protected static $getters = [
        ...
        'class_of_travel' => 'getClassOfTravel',
    ...
    const CLASS_OF_TRAVEL_FIRST_CLASS = 'FIRST_CLASS';
    const CLASS_OF_TRAVEL_BUSINESS_CLASS = 'BUSINESS_CLASS';
    const CLASS_OF_TRAVEL_ECONOMY = 'ECONOMY';
    const CLASS_OF_TRAVEL_PREMIUM_ECONOMY = 'PREMIUM_ECONOMY';
     ...
     * @return string[]
     */
    public function getClassOfTravelAllowableValues()
    {
        return [
            self::CLASS_OF_TRAVEL_FIRST_CLASS,
            self::CLASS_OF_TRAVEL_BUSINESS_CLASS,
            self::CLASS_OF_TRAVEL_ECONOMY,
            self::CLASS_OF_TRAVEL_PREMIUM_ECONOMY,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['airline_code'] = $data['airline_code'] ?? null;
        $this->container['flight_date'] = $data['flight_date'] ?? null;
        $this->container['departure_airport'] = $data['departure_airport'] ?? null;
        $this->container['destination_airport'] = $data['destination_airport'] ?? null;
        $this->container['class_of_travel'] = $data['class_of_travel'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getClassOfTravelAllowableValues();
        if (!is_null($this->container['class_of_travel']) && !in_array($this->container['class_of_travel'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'class_of_travel', must be one of '%s'",
                $this->container['class_of_travel'],
     ...
     * Sets version
     *
     * @param string|null $version The version of AirlineMetaData field (used for tracking schema changes to the field)
     *
     * @return self
     */
     ...
     * Sets airline_code
     *
     * @param string|null $airline_code IATA 2-letter airline code. It identifies the carrier. Example: AA (American Airlines)
     *
     * @return self
     */
     ...
     * Sets flight_date
     *
     * @param \DateTime|null $flight_date Flight departure date. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`). The time mentioned here is local time
     *
     * @return self
     */
     ...
     *
     * @param string|null $departure_airport IATA 3-letter code of the departure airport. Example: CDG
     *
     * @return self
     */
     ...
     *
     * @param string|null $destination_airport IATA 3-letter code of the departure airport. Example: LUX
     *
     * @return self
     */
    ...
    /**
     * Gets class_of_travel
     *
     * @return string|null
     */
    public function getClassOfTravel()
    {
        return $this->container['class_of_travel'];
    }

    /**
     * Sets class_of_travel
     *
     * @param string|null $class_of_travel travel class identifier.
     *
     * @return self
     */
    public function setClassOfTravel($class_of_travel)
    {
        $allowedValues = $this->getClassOfTravelAllowableValues();
        if (!is_null($class_of_travel) && !in_array($class_of_travel, $allowedValues, true)) {
        ...
        $this->container['class_of_travel'] = $class_of_travel;
     ...
     *
     * @param int|null $booked_last_time Days since the buyer booked a flight to the same destination last time. Use value -1 if buyer books this destination for the first time.
     *
     * @return self
     */
     ...
     * Gets passengers
     *
     * @return \Datatrans\Client\Model\Passenger|null
     */
     ...
     * Sets passengers
     *
     * @param \Datatrans\Client\Model\Passenger|null $passengers passengers
     *
     * @return self
     */
