...
/**
 * GooglePayValidateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GooglePayValidateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GooglePayValidateRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['signed_message'] = $data['signed_message'] ?? null;
    }
     ...
     * Sets signature
     *
     * @param string|null $signature Verifies that the message came from Google. It's Base64-encoded, and created with ECDSA by the intermediate signing key.
     *
     * @return self
     */
     ...
     *
     * @param string|null $protocol_version Identifies the encryption or signing scheme under which the message was created. It allows the protocol to evolve over time, if needed.
     *
     * @return self
     */
     ...
     * Sets signed_message
     *
     * @param string|null $signed_message A JSON object serialized as a string that contains the encryptedMessage, ephemeralPublicKey, and tag. It's serialized to simplify the signature verification process.
     *
     * @return self
     */
