...
/**
 * AliasInfoResponse Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class AliasInfoResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AliasInfoResponse';
    ...
    protected static $openAPITypes = [
        ...
        'card' => '\Datatrans\Client\Model\AliasCardInfoDetail'
    ];
     ...
     * Sets alias
     *
     * @param string|null $alias The requested alias.
     *
     * @return self
     */
    ...
    public function setFingerprint($fingerprint)
    {
        if (!is_null($fingerprint) && (mb_strlen($fingerprint) > 24)) {
            throw new \InvalidArgumentException('invalid length for $fingerprint when calling AliasInfoResponse., must be smaller than or equal to 24.');
        }
        if (!is_null($fingerprint) && (mb_strlen($fingerprint) < 24)) {
            throw new \InvalidArgumentException('invalid length for $fingerprint when calling AliasInfoResponse., must be bigger than or equal to 24.');
        }
        if (!is_null($fingerprint) && (!preg_match("/F-[A-Za-z0-9_-]{22}/", $fingerprint))) {
            throw new \InvalidArgumentException("invalid value for $fingerprint when calling AliasInfoResponse., must conform to the pattern /F-[A-Za-z0-9_-]{22}/.");
        }
     ...
     * Sets masked
     *
     * @param string|null $masked The nonsensitive masked representation of the value behind the alias (e.g. `490000xxxxxx0003` for aliases of type `CARD`)
     *
     * @return self
     */
     ...
     * Sets date_created
     *
     * @param \DateTime|null $date_created Creation date
     *
     * @return self
     */
     ...
     * Gets card
     *
     * @return \Datatrans\Client\Model\AliasCardInfoDetail|null
     */
     ...
     * Sets card
     *
     * @param \Datatrans\Client\Model\AliasCardInfoDetail|null $card card
     *
     * @return self
     */
