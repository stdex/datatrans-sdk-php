...
/**
 * ApplePayValidateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ApplePayValidateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplePayValidateRequest';
    ...
    protected static $openAPITypes = [
        'data' => 'string',
        'header' => '\Datatrans\Client\Model\Header',
        'signature' => 'string',
        'version' => 'string'
    ];
     ...
     * Sets data
     *
     * @param string|null $data Encrypted payment data.
     *
     * @return self
     */
     ...
     * Gets header
     *
     * @return \Datatrans\Client\Model\Header|null
     */
     ...
     * Sets header
     *
     * @param \Datatrans\Client\Model\Header|null $header header
     *
     * @return self
     */
     ...
     * Sets signature
     *
     * @param string|null $signature Signature of the payment and header data. The signature includes the signing certificate, its intermediate CA certificate, and information about the signing algorithm.
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param string|null $version Version information about the payment token. The token uses `EC_v1` for ECC-encrypted data, and `RSA_v1` for RSA-encrypted data.
     *
     * @return self
     */
