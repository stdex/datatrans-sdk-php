...
/**
 * SecureFieldsInitResponse Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class SecureFieldsInitResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecureFieldsInitResponse';
     ...
     * Sets transaction_id
     *
     * @param string|null $transaction_id The `transactionId` to be used when calling SecureFields.init(). If no further action happens with the `transactionId` after initialization, it will be invalidated after 30 minutes.
     *
     * @return self
     */
