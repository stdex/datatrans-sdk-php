...
/**
 * EasyPayValidateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class EasyPayValidateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EasyPayValidateRequest';
