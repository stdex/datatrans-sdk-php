...
/**
 * SwissBillingAuthorizeRequest Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class SwissBillingAuthorizeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SwissBillingAuthorizeRequest';
    ...
    protected static $setters = [
        ...
        'customer_subscription' => 'setCustomerSubscription'
    ];
    ...
    protected static $getters = [
        ...
        'customer_subscription' => 'getCustomerSubscription'
    ];
    ...
    {
        $this->container['payment_period'] = $data['payment_period'] ?? null;
        $this->container['customer_subscription'] = $data['customer_subscription'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['customer_subscription'] === null) {
            $invalidProperties[] = "'customer_subscription' can't be null";
        }
     ...
     * Sets payment_period
     *
     * @param int|null $payment_period payment_period
     *
     * @return self
     */
    ...
    /**
     * Gets customer_subscription
     *
     * @return string
     */
    public function getCustomerSubscription()
    {
        return $this->container['customer_subscription'];
    }

    /**
     * Sets customer_subscription
     *
     * @param string $customer_subscription customer_subscription
     *
     * @return self
     */
    public function setCustomerSubscription($customer_subscription)
    {
        $this->container['customer_subscription'] = $customer_subscription;
