 ...
 */
class Secure3DResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets enrolled
     *
     * @param bool|null $enrolled Whether the used credit card alias (or card number) is 3D enrolled or not.
     *
     * @return self
     */
