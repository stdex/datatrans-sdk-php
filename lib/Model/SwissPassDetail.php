...
/**
 * SwissPassDetail Class Doc Comment
 *
 * @category Class
 ...
 */
class SwissPassDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SwissPassDetail';
