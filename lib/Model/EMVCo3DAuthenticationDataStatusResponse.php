...
/**
 * EMVCo3DAuthenticationDataStatusResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class EMVCo3DAuthenticationDataStatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EMVCo3DAuthenticationDataStatusResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['card_holder_info'] = $data['card_holder_info'] ?? null;
        $this->container['trans_status_reason'] = $data['trans_status_reason'] ?? null;
    }
    ...
    public function setEci($eci)
    {
        ...
        if (!is_null($eci) && (mb_strlen($eci) > 2)) {
            throw new \InvalidArgumentException('invalid length for $eci when calling EMVCo3DAuthenticationDataStatusResponse., must be smaller than or equal to 2.');
        }
        if (!is_null($eci) && (mb_strlen($eci) < 2)) {
            throw new \InvalidArgumentException('invalid length for $eci when calling EMVCo3DAuthenticationDataStatusResponse., must be bigger than or equal to 2.');
        }
        if (!is_null($eci) && (!preg_match("/\\d{2}/", $eci))) {
            throw new \InvalidArgumentException("invalid value for $eci when calling EMVCo3DAuthenticationDataStatusResponse., must conform to the pattern /\\d{2}/.");
        }
    ...
    public function setDirectoryResponse($directory_response)
    {
        ...
        if (!is_null($directory_response) && (mb_strlen($directory_response) > 1)) {
            throw new \InvalidArgumentException('invalid length for $directory_response when calling EMVCo3DAuthenticationDataStatusResponse., must be smaller than or equal to 1.');
        }
        if (!is_null($directory_response) && (mb_strlen($directory_response) < 1)) {
            throw new \InvalidArgumentException('invalid length for $directory_response when calling EMVCo3DAuthenticationDataStatusResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setAuthenticationResponse($authentication_response)
    {
        ...
        if (!is_null($authentication_response) && (mb_strlen($authentication_response) > 1)) {
            throw new \InvalidArgumentException('invalid length for $authentication_response when calling EMVCo3DAuthenticationDataStatusResponse., must be smaller than or equal to 1.');
        }
        if (!is_null($authentication_response) && (mb_strlen($authentication_response) < 1)) {
            throw new \InvalidArgumentException('invalid length for $authentication_response when calling EMVCo3DAuthenticationDataStatusResponse., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $card_holder_info Text provided by the ACS/Issuer to Cardholder during a transaction that was not authenticated by the ACS. The Issuer can optionally provide information to Cardholder. For example, \"Additional authentication is needed for this transaction, please contact (Issuer Name) at xxx-xxx-xxxx.\"
     *
     * @return self
     */
