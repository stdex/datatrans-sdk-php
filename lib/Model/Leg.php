...
class Leg implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'departure_time' => '\Datatrans\Client\Model\LocalTime',
        'arrival_time' => '\Datatrans\Client\Model\LocalTime',
        'class' => 'string'
    ];
    ...
    {
        $this->container['departure_airport'] = $data['departure_airport'] ?? null;
        $this->container['arrival_airport'] = $data['arrival_airport'] ?? null;
        $this->container['carrier'] = $data['carrier'] ?? null;
        $this->container['fare_basis'] = $data['fare_basis'] ?? null;
        $this->container['flight_number'] = $data['flight_number'] ?? null;
        $this->container['flight_date'] = $data['flight_date'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['departure_airport']) && (mb_strlen($this->container['departure_airport']) > 5)) {
            $invalidProperties[] = "invalid value for 'departure_airport', the character length must be smaller than or equal to 5.";
        }

        if (!is_null($this->container['departure_airport']) && (mb_strlen($this->container['departure_airport']) < 1)) {
            $invalidProperties[] = "invalid value for 'departure_airport', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['arrival_airport']) && (mb_strlen($this->container['arrival_airport']) > 5)) {
            $invalidProperties[] = "invalid value for 'arrival_airport', the character length must be smaller than or equal to 5.";
        }

        if (!is_null($this->container['arrival_airport']) && (mb_strlen($this->container['arrival_airport']) < 1)) {
            $invalidProperties[] = "invalid value for 'arrival_airport', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['carrier']) && (mb_strlen($this->container['carrier']) > 2)) {
            $invalidProperties[] = "invalid value for 'carrier', the character length must be smaller than or equal to 2.";
        }

        if (!is_null($this->container['carrier']) && (mb_strlen($this->container['carrier']) < 0)) {
            $invalidProperties[] = "invalid value for 'carrier', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['fare_basis']) && (mb_strlen($this->container['fare_basis']) > 10)) {
            $invalidProperties[] = "invalid value for 'fare_basis', the character length must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['fare_basis']) && (mb_strlen($this->container['fare_basis']) < 0)) {
            $invalidProperties[] = "invalid value for 'fare_basis', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['flight_number']) && (mb_strlen($this->container['flight_number']) > 10)) {
            $invalidProperties[] = "invalid value for 'flight_number', the character length must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['flight_number']) && (mb_strlen($this->container['flight_number']) < 0)) {
            $invalidProperties[] = "invalid value for 'flight_number', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['class']) && (mb_strlen($this->container['class']) > 1)) {
            $invalidProperties[] = "invalid value for 'class', the character length must be smaller than or equal to 1.";
        }

        if (!is_null($this->container['class']) && (mb_strlen($this->container['class']) < 1)) {
            $invalidProperties[] = "invalid value for 'class', the character length must be bigger than or equal to 1.";
        }
     ...
     *
     * @param string|null $departure_airport The origin or departure airport code for this leg.
     *
     * @return self
     */
    public function setDepartureAirport($departure_airport)
    {
        if (!is_null($departure_airport) && (mb_strlen($departure_airport) > 5)) {
            throw new \InvalidArgumentException('invalid length for $departure_airport when calling Leg., must be smaller than or equal to 5.');
        }
        if (!is_null($departure_airport) && (mb_strlen($departure_airport) < 1)) {
            throw new \InvalidArgumentException('invalid length for $departure_airport when calling Leg., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $arrival_airport The destination or arrival airport code for this leg.
     *
     * @return self
     */
    public function setArrivalAirport($arrival_airport)
    {
        if (!is_null($arrival_airport) && (mb_strlen($arrival_airport) > 5)) {
            throw new \InvalidArgumentException('invalid length for $arrival_airport when calling Leg., must be smaller than or equal to 5.');
        }
        if (!is_null($arrival_airport) && (mb_strlen($arrival_airport) < 1)) {
            throw new \InvalidArgumentException('invalid length for $arrival_airport when calling Leg., must be bigger than or equal to 1.');
        }
     ...
     * Sets carrier
     *
     * @param string|null $carrier Carrier airline code(i.e.'OS')
     *
     * @return self
     */
    public function setCarrier($carrier)
    {
        if (!is_null($carrier) && (mb_strlen($carrier) > 2)) {
            throw new \InvalidArgumentException('invalid length for $carrier when calling Leg., must be smaller than or equal to 2.');
        }
        if (!is_null($carrier) && (mb_strlen($carrier) < 0)) {
            throw new \InvalidArgumentException('invalid length for $carrier when calling Leg., must be bigger than or equal to 0.');
        }
     ...
     * Sets fare_basis
     *
     * @param string|null $fare_basis Fare  basis (i.e. 'URRVP/OCF')
     *
     * @return self
     */
    public function setFareBasis($fare_basis)
    {
        if (!is_null($fare_basis) && (mb_strlen($fare_basis) > 10)) {
            throw new \InvalidArgumentException('invalid length for $fare_basis when calling Leg., must be smaller than or equal to 10.');
        }
        if (!is_null($fare_basis) && (mb_strlen($fare_basis) < 0)) {
            throw new \InvalidArgumentException('invalid length for $fare_basis when calling Leg., must be bigger than or equal to 0.');
        }
     ...
     * Sets flight_number
     *
     * @param string|null $flight_number Flight number (i.e. OS 834)
     *
     * @return self
     */
    public function setFlightNumber($flight_number)
    {
        if (!is_null($flight_number) && (mb_strlen($flight_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $flight_number when calling Leg., must be smaller than or equal to 10.');
        }
        if (!is_null($flight_number) && (mb_strlen($flight_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $flight_number when calling Leg., must be bigger than or equal to 0.');
        }
     ...
     * Sets flight_date
     *
     * @param \DateTime|null $flight_date Date of flight. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (`YYYY-MM-DD`).
     *
     * @return self
     */
     ...
     * Gets departure_time
     *
     * @return \Datatrans\Client\Model\LocalTime|null
     */
     ...
     * Sets departure_time
     *
     * @param \Datatrans\Client\Model\LocalTime|null $departure_time departure_time
     *
     * @return self
     */
     ...
     * Sets arrival_time
     *
     * @param \Datatrans\Client\Model\LocalTime|null $arrival_time arrival_time
     *
     * @return self
     */
     ...
     * Sets class
     *
     * @param string|null $class Class code (i.e.'U')
     *
     * @return self
     */
    public function setClass($class)
    {
        if (!is_null($class) && (mb_strlen($class) > 1)) {
            throw new \InvalidArgumentException('invalid length for $class when calling Leg., must be smaller than or equal to 1.');
        }
        if (!is_null($class) && (mb_strlen($class) < 1)) {
            throw new \InvalidArgumentException('invalid length for $class when calling Leg., must be bigger than or equal to 1.');
        }
