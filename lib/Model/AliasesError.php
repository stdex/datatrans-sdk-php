...
/**
 * AliasesError Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class AliasesError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AliasesError';
    ...
    protected static $openAPITypes = [
        'code' => '\Datatrans\Client\Model\AliasesErrorCode',
        'message' => 'string'
    ];
     ...
     * Gets code
     *
     * @return \Datatrans\Client\Model\AliasesErrorCode|null
     */
     ...
     * Sets code
     *
     * @param \Datatrans\Client\Model\AliasesErrorCode|null $code code
     *
     * @return self
     */
