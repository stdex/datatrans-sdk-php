...
/**
 * TransactionsErrorCode Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
...
class TransactionsErrorCode
{
    ...
    const INVALID_JSON_PAYLOAD = 'INVALID_JSON_PAYLOAD';
    const UNRECOGNIZED_PROPERTY = 'UNRECOGNIZED_PROPERTY';
    const INVALID_PROPERTY = 'INVALID_PROPERTY';
    const CLIENT_ERROR = 'CLIENT_ERROR';
    const SERVER_ERROR = 'SERVER_ERROR';
    const INVALID_TRANSACTION_STATUS = 'INVALID_TRANSACTION_STATUS';
    const TRANSACTION_NOT_FOUND = 'TRANSACTION_NOT_FOUND';
    const EXPIRED_CARD = 'EXPIRED_CARD';
    const INVALID_CARD = 'INVALID_CARD';
    const BLOCKED_CARD = 'BLOCKED_CARD';
    const UNSUPPORTED_CARD = 'UNSUPPORTED_CARD';
    const INVALID_ALIAS = 'INVALID_ALIAS';
    const INVALID_CVV = 'INVALID_CVV';
    const DUPLICATE_REFNO = 'DUPLICATE_REFNO';
    const DECLINED = 'DECLINED';
    const SOFT_DECLINED = 'SOFT_DECLINED';
    const INVALID_SIGN = 'INVALID_SIGN';
    const BLOCKED_BY_VELOCITY_CHECKER = 'BLOCKED_BY_VELOCITY_CHECKER';
    const THIRD_PARTY_ERROR = 'THIRD_PARTY_ERROR';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::UNKNOWN_ERROR,
            self::UNAUTHORIZED,
            self::INVALID_JSON_PAYLOAD,
            self::UNRECOGNIZED_PROPERTY,
            self::INVALID_PROPERTY,
            self::CLIENT_ERROR,
            self::SERVER_ERROR,
            self::INVALID_TRANSACTION_STATUS,
            self::TRANSACTION_NOT_FOUND,
            self::EXPIRED_CARD,
            self::INVALID_CARD,
            self::BLOCKED_CARD,
            self::UNSUPPORTED_CARD,
            self::INVALID_ALIAS,
            self::INVALID_CVV,
            self::DUPLICATE_REFNO,
            self::DECLINED,
            self::SOFT_DECLINED,
            self::INVALID_SIGN,
            self::BLOCKED_BY_VELOCITY_CHECKER,
