...
class Passenger implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['number_of_passengers'] = $data['number_of_passengers'] ?? null;
        $this->container['number_of_children'] = $data['number_of_children'] ?? null;
        $this->container['number_of_infants'] = $data['number_of_infants'] ?? null;
    }
     ...
     *
     * @param int|null $number_of_passengers Number of passengers
     *
     * @return self
     */
     ...
     *
     * @param int|null $number_of_children The number of passengers who are children (ages 2 to 18)
     *
     * @return self
     */
     ...
     *
     * @param int|null $number_of_infants The number of passengers who are under the age of 2
     *
     * @return self
     */
