...
/**
 * AliasesResponseBase Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class AliasesResponseBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AliasesResponseBase';
    ...
    protected static $openAPITypes = [
        'error' => '\Datatrans\Client\Model\AliasesError'
    ];
     ...
     * Gets error
     *
     * @return \Datatrans\Client\Model\AliasesError|null
     */
     ...
     * Sets error
     *
     * @param \Datatrans\Client\Model\AliasesError|null $error error
     *
     * @return self
     */
