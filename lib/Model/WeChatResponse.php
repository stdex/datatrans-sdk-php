 ...
 */
class WeChatResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WeChatResponse';
    ...
    protected static $setters = [
        'prepay_id' => 'setPrepayId',
        'timestamp' => 'setTimestamp',
        'nonce_string' => 'setNonceString',
        'pay_sign' => 'setPaySign'
    ];
    ...
    {
        $this->container['prepay_id'] = $data['prepay_id'] ?? null;
        $this->container['timestamp'] = $data['timestamp'] ?? null;
        $this->container['nonce_string'] = $data['nonce_string'] ?? null;
        $this->container['pay_sign'] = $data['pay_sign'] ?? null;
    }
    ...
    {
        return $this->container['prepay_id'];
    }

    /**
     * Sets prepay_id
     *
     * @param string|null $prepay_id The order prepayId. To be used by the Mini APP in the payment confirmation process.
     *
     * @return self
     */
    public function setPrepayId($prepay_id)
    {
        $this->container['prepay_id'] = $prepay_id;
    ...
    {
        return $this->container['nonce_string'];
    }

    /**
     * Sets nonce_string
     *
     * @param string|null $nonce_string nonce_string
     *
     * @return self
     */
    public function setNonceString($nonce_string)
    {
        $this->container['nonce_string'] = $nonce_string;
    ...
    {
        return $this->container['pay_sign'];
    }

    /**
     * Sets pay_sign
     *
     * @param string|null $pay_sign pay_sign
     *
     * @return self
     */
    public function setPaySign($pay_sign)
    {
        $this->container['pay_sign'] = $pay_sign;
