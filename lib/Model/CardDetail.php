...
class CardDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'expiry_month' => 'string',
        'expiry_year' => 'string',
        'info' => '\Datatrans\Client\Model\CardInfo',
        'wallet_indicator' => 'string',
        '_3_d' => '\Datatrans\Client\Model\EMVCo3DAuthenticationDataStatusResponse'
    ];
    ...
    protected static $setters = [
        ...
        'masked' => 'setMasked',
        'alias_cvv' => 'setAliasCvv',
        'expiry_month' => 'setExpiryMonth',
        'expiry_year' => 'setExpiryYear',
        'info' => 'setInfo',
        'wallet_indicator' => 'setWalletIndicator',
        '_3_d' => 'set3D'
    ];
    ...
    protected static $getters = [
        ...
        'masked' => 'getMasked',
        'alias_cvv' => 'getAliasCvv',
        'expiry_month' => 'getExpiryMonth',
        'expiry_year' => 'getExpiryYear',
        'info' => 'getInfo',
        'wallet_indicator' => 'getWalletIndicator',
        '_3_d' => 'get3D'
    ];
    ...
    const WALLET_INDICATOR_APL = 'APL';
    const WALLET_INDICATOR_PAY = 'PAY';
    const WALLET_INDICATOR_SAM = 'SAM';
     ...
     * @return string[]
     */
    public function getWalletIndicatorAllowableValues()
    {
        return [
            self::WALLET_INDICATOR_APL,
            self::WALLET_INDICATOR_PAY,
            self::WALLET_INDICATOR_SAM,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['alias_cvv'] = $data['alias_cvv'] ?? null;
        ...
        $this->container['wallet_indicator'] = $data['wallet_indicator'] ?? null;
        $this->container['_3_d'] = $data['_3_d'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['fingerprint']) && (mb_strlen($this->container['fingerprint']) > 24)) {
            $invalidProperties[] = "invalid value for 'fingerprint', the character length must be smaller than or equal to 24.";
        }

        if (!is_null($this->container['fingerprint']) && (mb_strlen($this->container['fingerprint']) < 24)) {
            $invalidProperties[] = "invalid value for 'fingerprint', the character length must be bigger than or equal to 24.";
        }

        if (!is_null($this->container['fingerprint']) && !preg_match("/F-[A-Za-z0-9_-]{22}/", $this->container['fingerprint'])) {
            $invalidProperties[] = "invalid value for 'fingerprint', must be conform to the pattern /F-[A-Za-z0-9_-]{22}/.";
        }
        ...
        if (!is_null($this->container['expiry_month']) && !preg_match("/\\d{2}/", $this->container['expiry_month'])) {
            $invalidProperties[] = "invalid value for 'expiry_month', must be conform to the pattern /\\d{2}/.";
        }
        ...
        if (!is_null($this->container['expiry_year']) && !preg_match("/\\d{2}/", $this->container['expiry_year'])) {
            $invalidProperties[] = "invalid value for 'expiry_year', must be conform to the pattern /\\d{2}/.";
        }

        $allowedValues = $this->getWalletIndicatorAllowableValues();
        if (!is_null($this->container['wallet_indicator']) && !in_array($this->container['wallet_indicator'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'wallet_indicator', must be one of '%s'",
                $this->container['wallet_indicator'],
     ...
     * Sets alias
     *
     * @param string|null $alias The resulting alias, if requested or available.
     *
     * @return self
     */
     ...
     * Sets fingerprint
     *
     * @param string|null $fingerprint An unique identifier of the card number. Useful to identify multiple customers' or the same customer's transactions where the same card was used.
     *
     * @return self
     */
    public function setFingerprint($fingerprint)
    {
        if (!is_null($fingerprint) && (mb_strlen($fingerprint) > 24)) {
            throw new \InvalidArgumentException('invalid length for $fingerprint when calling CardDetail., must be smaller than or equal to 24.');
        }
        if (!is_null($fingerprint) && (mb_strlen($fingerprint) < 24)) {
            throw new \InvalidArgumentException('invalid length for $fingerprint when calling CardDetail., must be bigger than or equal to 24.');
        }
        if (!is_null($fingerprint) && (!preg_match("/F-[A-Za-z0-9_-]{22}/", $fingerprint))) {
            throw new \InvalidArgumentException("invalid value for $fingerprint when calling CardDetail., must conform to the pattern /F-[A-Za-z0-9_-]{22}/.");
        }
     ...
     * Sets masked
     *
     * @param string|null $masked Masked credit card number. Can be used to display on a users profile page. For example: `424242xxxxxx4242`
     *
     * @return self
     */
    ...
    {
        return $this->container['alias_cvv'];
    }

    /**
     * Sets alias_cvv
     *
     * @param string|null $alias_cvv Alias of the CVV. Will be deleted immediately after authorization.
     *
     * @return self
     */
    public function setAliasCvv($alias_cvv)
    {
        $this->container['alias_cvv'] = $alias_cvv;
     ...
     * Sets expiry_month
     *
     * @param string|null $expiry_month The expiry month of the credit card alias.
     *
     * @return self
     */
    public function setExpiryMonth($expiry_month)
    {
        if (!is_null($expiry_month) && (mb_strlen($expiry_month) > 2)) {
            throw new \InvalidArgumentException('invalid length for $expiry_month when calling CardDetail., must be smaller than or equal to 2.');
        }
        if (!is_null($expiry_month) && (mb_strlen($expiry_month) < 2)) {
            throw new \InvalidArgumentException('invalid length for $expiry_month when calling CardDetail., must be bigger than or equal to 2.');
        }
        if (!is_null($expiry_month) && (!preg_match("/\\d{2}/", $expiry_month))) {
            throw new \InvalidArgumentException("invalid value for $expiry_month when calling CardDetail., must conform to the pattern /\\d{2}/.");
        }
     ...
     * Sets expiry_year
     *
     * @param string|null $expiry_year The expiry year of the credit card alias
     *
     * @return self
     */
    public function setExpiryYear($expiry_year)
    {
        if (!is_null($expiry_year) && (mb_strlen($expiry_year) > 2)) {
            throw new \InvalidArgumentException('invalid length for $expiry_year when calling CardDetail., must be smaller than or equal to 2.');
        }
        if (!is_null($expiry_year) && (mb_strlen($expiry_year) < 2)) {
            throw new \InvalidArgumentException('invalid length for $expiry_year when calling CardDetail., must be bigger than or equal to 2.');
        }
        if (!is_null($expiry_year) && (!preg_match("/\\d{2}/", $expiry_year))) {
            throw new \InvalidArgumentException("invalid value for $expiry_year when calling CardDetail., must conform to the pattern /\\d{2}/.");
        }
     ...
     * Gets info
     *
     * @return \Datatrans\Client\Model\CardInfo|null
     */
     ...
     * Sets info
     *
     * @param \Datatrans\Client\Model\CardInfo|null $info info
     *
     * @return self
     */
    ...
    /**
     * Gets wallet_indicator
     *
     * @return string|null
     */
    public function getWalletIndicator()
    {
        return $this->container['wallet_indicator'];
    }

    /**
     * Sets wallet_indicator
     *
     * @param string|null $wallet_indicator wallet_indicator
     *
     * @return self
     */
    public function setWalletIndicator($wallet_indicator)
    {
        $allowedValues = $this->getWalletIndicatorAllowableValues();
        if (!is_null($wallet_indicator) && !in_array($wallet_indicator, $allowedValues, true)) {
        ...
        $this->container['wallet_indicator'] = $wallet_indicator;
     ...
     * Gets _3_d
     *
     * @return \Datatrans\Client\Model\EMVCo3DAuthenticationDataStatusResponse|null
     */
    public function get3D()
    {
        return $this->container['_3_d'];
    }

    /**
     * Sets _3_d
     *
     * @param \Datatrans\Client\Model\EMVCo3DAuthenticationDataStatusResponse|null $_3_d _3_d
     *
     * @return self
     */
    public function set3D($_3_d)
    {
        $this->container['_3_d'] = $_3_d;
