...
class CardInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets brand
     *
     * @param string|null $brand The brand of the credit card (e.g. VISA CREDIT).
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of the card (`credit`, `debit` or `prepaid`). The property will not be present if the card type is unknown.
     *
     * @return self
     */
     ...
     * Sets usage
     *
     * @param string|null $usage The usage of the card (`consumer`, `corporate` or `unknown`)
     *
     * @return self
     */
     ...
     * Sets issuer
     *
     * @param string|null $issuer The issuer of the card
     *
     * @return self
     */
