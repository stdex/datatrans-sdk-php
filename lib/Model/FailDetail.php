 ...
 */
class FailDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FailDetail';
    ...
    const REASON_CARD_INVALID = 'card_invalid';
    const REASON_DECLINED = 'declined';
    const REASON_INCOMPLETE = 'incomplete';
    const REASON_TIMEOUT = 'timeout';
    const REASON_INVALID_SETUP = 'invalid_setup';
    const REASON_SECURE_AUTHENTICATION = 'secure_authentication';
    const REASON_ERROR_ON_START = 'error_on_start';
    ...
    {
        return [
            self::REASON_CARD_INVALID,
            self::REASON_DECLINED,
            self::REASON_INCOMPLETE,
            self::REASON_TIMEOUT,
            self::REASON_INVALID_SETUP,
            self::REASON_SECURE_AUTHENTICATION,
            self::REASON_ERROR_ON_START,
     ...
     * Sets reason
     *
     * @param string|null $reason The failure reason if an error occurred.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message A detailed message describing the occurred error.
     *
     * @return self
     */
