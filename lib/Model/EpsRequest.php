...
class EpsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EpsRequest';
    ...
    protected static $setters = [
        'bankbic' => 'setBankbic',
        'order_info_text' => 'setOrderInfoText'
    ];
    ...
    protected static $getters = [
        'bankbic' => 'getBankbic',
        'order_info_text' => 'getOrderInfoText'
    ];
    ...
    {
        $this->container['bankbic'] = $data['bankbic'] ?? null;
        $this->container['order_info_text'] = $data['order_info_text'] ?? 'refno';
    }
    ...
    {
        return $this->container['bankbic'];
    }

    /**
     * Sets bankbic
     *
     * @param string|null $bankbic Identification of the customer’s (buyer’s) financial institution by a BIC.
     *
     * @return self
     */
    public function setBankbic($bankbic)
    {
        $this->container['bankbic'] = $bankbic;

        return $this;
    }

    /**
     * Gets order_info_text
     *
     * @return string|null
     */
    public function getOrderInfoText()
    {
        return $this->container['order_info_text'];
    }

    /**
     * Sets order_info_text
     *
     * @param string|null $order_info_text Text between the beneficiary/merchant and the buyer which will not be part of the payment instruction. If submitted, the final orderInfoText will be: `refno + ' ' + orderInfoText`
     *
     * @return self
     */
    public function setOrderInfoText($order_info_text)
    {
        $this->container['order_info_text'] = $order_info_text;
