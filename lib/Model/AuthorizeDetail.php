...
/**
 * AuthorizeDetail Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class AuthorizeDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthorizeDetail';
     ...
     * Sets amount
     *
     * @param int|null $amount The authorization amount.
     *
     * @return self
     */
