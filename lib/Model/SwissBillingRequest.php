...
/**
 * SwissBillingRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SwissBillingRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SwissBillingRequest';
