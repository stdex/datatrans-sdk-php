...
/**
 * CardInitThreeDSecure Class Doc Comment
 *
 * @category Class
 ...
 */
class CardInitThreeDSecure implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CardInitThreeDSecure';
    ...
    protected static $openAPITypes = [
        'three_ds_requestor' => '\Datatrans\Client\Model\ThreeDSRequestor',
        'three_ds_requestor_url' => 'string',
        'cardholder_account' => '\Datatrans\Client\Model\CardholderAccount',
        'cardholder' => '\Datatrans\Client\Model\Cardholder',
        'purchase' => '\Datatrans\Client\Model\Purchase',
        'merchant' => '\Datatrans\Client\Model\MerchantData',
        'broad_info' => 'string',
        'browser_information' => '\Datatrans\Client\Model\Browser',
        'three_ri_ind' => 'string',
        'apply' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'three_ds_requestor' => null,
        'three_ds_requestor_url' => 'url',
    ...
    protected static $setters = [
        'three_ds_requestor' => 'setThreeDsRequestor',
        'three_ds_requestor_url' => 'setThreeDsRequestorUrl',
        'cardholder_account' => 'setCardholderAccount',
        'cardholder' => 'setCardholder',
        'purchase' => 'setPurchase',
        'merchant' => 'setMerchant',
        'broad_info' => 'setBroadInfo',
        'browser_information' => 'setBrowserInformation',
        'three_ri_ind' => 'setThreeRiInd',
        'apply' => 'setApply'
    ];
    ...
    protected static $getters = [
        'three_ds_requestor' => 'getThreeDsRequestor',
        'three_ds_requestor_url' => 'getThreeDsRequestorUrl',
        'cardholder_account' => 'getCardholderAccount',
        'cardholder' => 'getCardholder',
        'purchase' => 'getPurchase',
        'merchant' => 'getMerchant',
        'broad_info' => 'getBroadInfo',
        'browser_information' => 'getBrowserInformation',
        'three_ri_ind' => 'getThreeRiInd',
        'apply' => 'getApply'
    ];
    ...
    const THREE_RI_IND__01 = '01';
    const THREE_RI_IND__02 = '02';
    const THREE_RI_IND__03 = '03';
    const THREE_RI_IND__04 = '04';
    const THREE_RI_IND__05 = '05';
     ...
     * @return string[]
     */
    public function getThreeRiIndAllowableValues()
    {
        return [
            self::THREE_RI_IND__01,
            self::THREE_RI_IND__02,
            self::THREE_RI_IND__03,
            self::THREE_RI_IND__04,
            self::THREE_RI_IND__05,
        ];
    }
    ...
    {
        $this->container['three_ds_requestor'] = $data['three_ds_requestor'] ?? null;
        $this->container['three_ds_requestor_url'] = $data['three_ds_requestor_url'] ?? null;
        $this->container['cardholder_account'] = $data['cardholder_account'] ?? null;
        $this->container['cardholder'] = $data['cardholder'] ?? null;
        $this->container['purchase'] = $data['purchase'] ?? null;
        $this->container['merchant'] = $data['merchant'] ?? null;
        $this->container['broad_info'] = $data['broad_info'] ?? null;
        $this->container['browser_information'] = $data['browser_information'] ?? null;
        $this->container['three_ri_ind'] = $data['three_ri_ind'] ?? null;
        $this->container['apply'] = $data['apply'] ?? true;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getThreeRiIndAllowableValues();
        if (!is_null($this->container['three_ri_ind']) && !in_array($this->container['three_ri_ind'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'three_ri_ind', must be one of '%s'",
                $this->container['three_ri_ind'],
    ...
    /**
     * Gets three_ds_requestor
     *
     * @return \Datatrans\Client\Model\ThreeDSRequestor|null
     */
    public function getThreeDsRequestor()
    {
        return $this->container['three_ds_requestor'];
    }

    /**
     * Sets three_ds_requestor
     *
     * @param \Datatrans\Client\Model\ThreeDSRequestor|null $three_ds_requestor three_ds_requestor
     *
     * @return self
     */
    public function setThreeDsRequestor($three_ds_requestor)
    {
        $this->container['three_ds_requestor'] = $three_ds_requestor;
     ...
     *
     * @param string|null $three_ds_requestor_url three_ds_requestor_url
     *
     * @return self
     */
    ...
    /**
     * Gets cardholder_account
     *
     * @return \Datatrans\Client\Model\CardholderAccount|null
     */
    public function getCardholderAccount()
    {
        return $this->container['cardholder_account'];
    }

    /**
     * Sets cardholder_account
     *
     * @param \Datatrans\Client\Model\CardholderAccount|null $cardholder_account cardholder_account
     *
     * @return self
     */
    public function setCardholderAccount($cardholder_account)
    {
        $this->container['cardholder_account'] = $cardholder_account;
     ...
     * Gets cardholder
     *
     * @return \Datatrans\Client\Model\Cardholder|null
     */
     ...
     * Sets cardholder
     *
     * @param \Datatrans\Client\Model\Cardholder|null $cardholder cardholder
     *
     * @return self
     */
     ...
     * Gets purchase
     *
     * @return \Datatrans\Client\Model\Purchase|null
     */
     ...
     * Sets purchase
     *
     * @param \Datatrans\Client\Model\Purchase|null $purchase purchase
     *
     * @return self
     */
     ...
     * Gets merchant
     *
     * @return \Datatrans\Client\Model\MerchantData|null
     */
     ...
     * Sets merchant
     *
     * @param \Datatrans\Client\Model\MerchantData|null $merchant merchant
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getBroadInfo()
    {
        return $this->container['broad_info'];
    }

    /**
     * Sets broad_info
     *
     * @param string|null $broad_info broad_info
     *
     * @return self
     */
    public function setBroadInfo($broad_info)
    {
        $this->container['broad_info'] = $broad_info;

        return $this;
    }

    /**
     * Gets browser_information
     *
     * @return \Datatrans\Client\Model\Browser|null
     */
    public function getBrowserInformation()
    {
        return $this->container['browser_information'];
    }

    /**
     * Sets browser_information
     *
     * @param \Datatrans\Client\Model\Browser|null $browser_information browser_information
     *
     * @return self
     */
    public function setBrowserInformation($browser_information)
    {
        $this->container['browser_information'] = $browser_information;
     ...
     * @return string|null
     */
    public function getThreeRiInd()
    {
        return $this->container['three_ri_ind'];
    }

    /**
     * Sets three_ri_ind
     *
     * @param string|null $three_ri_ind three_ri_ind
     *
     * @return self
     */
    public function setThreeRiInd($three_ri_ind)
    {
        $allowedValues = $this->getThreeRiIndAllowableValues();
        if (!is_null($three_ri_ind) && !in_array($three_ri_ind, $allowedValues, true)) {
        ...
        $this->container['three_ri_ind'] = $three_ri_ind;
     ...
     * Sets apply
     *
     * @param bool|null $apply Decides if the 3D secure process should be applied.
     *
     * @return self
     */
