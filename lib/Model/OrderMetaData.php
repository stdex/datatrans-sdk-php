...
/**
 * OrderMetaData Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderMetaData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderMetaData';
    ...
    protected static $openAPITypes = [
        ...
        'number_of_items' => 'int',
        'type' => 'string',
        'related_order_reference_id' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'type' => null,
        'related_order_reference_id' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'type' => 'type',
        'related_order_reference_id' => 'relatedOrderReferenceId'
    ];
    ...
    protected static $setters = [
        ...
        'type' => 'setType',
        'related_order_reference_id' => 'setRelatedOrderReferenceId'
    ];
    ...
    protected static $getters = [
        ...
        'type' => 'getType',
        'related_order_reference_id' => 'getRelatedOrderReferenceId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['related_order_reference_id'] = $data['related_order_reference_id'] ?? null;
    }
     ...
     * Sets version
     *
     * @param string|null $version The version of OrderMetaData field (used for tracking schema changes to the field).
     *
     * @return self
     */
     ...
     *
     * @param int|null $number_of_items The number of items that the order contains. For example, two cups of coffee.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Type of items. Physical, Digital, Mixed
     *
     * @return self
     */
    ...
    /**
     * Gets related_order_reference_id
     *
     * @return string|null
     */
    public function getRelatedOrderReferenceId()
    {
        return $this->container['related_order_reference_id'];
    }

    /**
     * Sets related_order_reference_id
     *
     * @param string|null $related_order_reference_id Order ID of the related order. For the deposit this field will be empty, while for any subsequent payment related to the same booking this will be the order ID of the deposit transaction.
     *
     * @return self
     */
    public function setRelatedOrderReferenceId($related_order_reference_id)
    {
        $this->container['related_order_reference_id'] = $related_order_reference_id;
