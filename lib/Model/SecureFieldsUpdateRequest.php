...
/**
 * SecureFieldsUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class SecureFieldsUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecureFieldsUpdateRequest';
     ...
     * Sets amount
     *
     * @param int|null $amount The newly to be used amount in the currency’s smallest unit. For example use 1000 for CHF 10.00.
     *
     * @return self
     */
    ...
    public function setCurrency($currency)
    {
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling SecureFieldsUpdateRequest., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling SecureFieldsUpdateRequest., must be bigger than or equal to 3.');
        }
