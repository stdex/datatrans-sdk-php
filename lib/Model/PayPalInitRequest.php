...
/**
 * PayPalInitRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PayPalInitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayPalInitRequest';
    ...
    protected static $openAPITypes = [
        'alias' => 'string',
        'image_url' => 'string',
        'display_shipping_details' => 'bool',
        'forward_customer_details' => 'bool',
        'return_customer_details' => 'bool',
        'create_order' => 'bool',
    ...
    protected static $openAPIFormats = [
        'alias' => null,
        'image_url' => null,
        'display_shipping_details' => null,
        'forward_customer_details' => null,
        'return_customer_details' => null,
        'create_order' => null,
    ...
    protected static $attributeMap = [
        'alias' => 'alias',
        'image_url' => 'imageUrl',
        'display_shipping_details' => 'displayShippingDetails',
        'forward_customer_details' => 'forwardCustomerDetails',
        'return_customer_details' => 'returnCustomerDetails',
    ...
    protected static $setters = [
        ...
        'display_shipping_details' => 'setDisplayShippingDetails',
        'forward_customer_details' => 'setForwardCustomerDetails',
        'return_customer_details' => 'setReturnCustomerDetails',
        'create_order' => 'setCreateOrder',
        'fraud_session_id' => 'setFraudSessionId',
        'transaction_context' => 'setTransactionContext'
    ];
    ...
    protected static $getters = [
        ...
        'display_shipping_details' => 'getDisplayShippingDetails',
        'forward_customer_details' => 'getForwardCustomerDetails',
        'return_customer_details' => 'getReturnCustomerDetails',
        'create_order' => 'getCreateOrder',
        'fraud_session_id' => 'getFraudSessionId',
        'transaction_context' => 'getTransactionContext'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['display_shipping_details'] = $data['display_shipping_details'] ?? null;
        $this->container['forward_customer_details'] = $data['forward_customer_details'] ?? null;
        $this->container['return_customer_details'] = $data['return_customer_details'] ?? null;
        $this->container['create_order'] = $data['create_order'] ?? null;
        $this->container['fraud_session_id'] = $data['fraud_session_id'] ?? null;
        $this->container['transaction_context'] = $data['transaction_context'] ?? null;
    }
     ...
     * Sets image_url
     *
     * @param string|null $image_url A https URL to the logo of the merchant.
     *
     * @return self
     */
    ...
    /**
     * Gets display_shipping_details
     *
     * @return bool|null
     */
    public function getDisplayShippingDetails()
    {
        return $this->container['display_shipping_details'];
    }

    /**
     * Sets display_shipping_details
     *
     * @param bool|null $display_shipping_details Regulates whether the shipping details are displayed or not. (Note: `forwardCustomerDetails` and `displayShippingDetails` should be set to `no` if the shipping details should not be shown on the PayPal page.
     *
     * @return self
     */
    public function setDisplayShippingDetails($display_shipping_details)
    {
        $this->container['display_shipping_details'] = $display_shipping_details;

        return $this;
    }

    /**
     * Gets forward_customer_details
     *
     * @return bool|null
     */
    public function getForwardCustomerDetails()
    {
        return $this->container['forward_customer_details'];
    }

    /**
     * Sets forward_customer_details
     *
     * @param bool|null $forward_customer_details `true` if the customer details (if submitted) should be forwarded to PayPal. Default is `false`.
     *
     * @return self
     */
    public function setForwardCustomerDetails($forward_customer_details)
    {
        $this->container['forward_customer_details'] = $forward_customer_details;

        return $this;
    }

    /**
     * Gets return_customer_details
     *
     * @return bool|null
     */
    public function getReturnCustomerDetails()
    {
        return $this->container['return_customer_details'];
    }

    /**
     * Sets return_customer_details
     *
     * @param bool|null $return_customer_details `true` if the customer details should be retrieved from PayPal.
     *
     * @return self
     */
    public function setReturnCustomerDetails($return_customer_details)
    {
        $this->container['return_customer_details'] = $return_customer_details;
    ...
    {
        return $this->container['create_order'];
    }

    /**
     * Sets create_order
     *
     * @param bool|null $create_order `true` if a PayPal AC2 order is to be created. Default is `false`.
     *
     * @return self
     */
    public function setCreateOrder($create_order)
    {
        $this->container['create_order'] = $create_order;
     ...
     *
     * @param string|null $fraud_session_id The PayPal FraudNet session identifier as specified in the API documentation.
     *
     * @return self
     */
    ...
    /**
     * Gets transaction_context
     *
     * @return object|null
     */
    public function getTransactionContext()
    {
        return $this->container['transaction_context'];
    }

    /**
     * Sets transaction_context
     *
     * @param object|null $transaction_context PayPal transaction context specific parameters. Use the same properties as you would for direct Transaction Context requests
     *
     * @return self
     */
    public function setTransactionContext($transaction_context)
    {
        $this->container['transaction_context'] = $transaction_context;
