...
class Header implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['public_key_hash'] = $data['public_key_hash'] ?? null;
     ...
     *
     * @param string|null $public_key_hash Hash of the X.509 encoded public key bytes of the merchant’s certificate.
     *
     * @return self
     */
     ...
     *
     * @param string|null $ephemeral_public_key Ephemeral public key bytes. `EC_v1` only.
     *
     * @return self
     */
     ...
     * Sets transaction_id
     *
     * @param string|null $transaction_id Transaction identifier, generated on the device.
     *
     * @return self
     */
