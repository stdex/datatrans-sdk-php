 ...
 */
class TwintDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TwintDetail';
     ...
     * Sets alias
     *
     * @param string|null $alias The Twint alias.
     *
     * @return self
     */
