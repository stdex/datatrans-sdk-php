...
/**
 * ThreeDSRequestorAuthenticationInformation Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class ThreeDSRequestorAuthenticationInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ThreeDSRequestorAuthenticationInformation';
    ...
    protected static $openAPIFormats = [
        ...
        'three_ds_req_auth_timestamp' => 'date-time',
    ...
    const THREE_DS_REQ_AUTH_METHOD__01 = '01';
    const THREE_DS_REQ_AUTH_METHOD__02 = '02';
    const THREE_DS_REQ_AUTH_METHOD__03 = '03';
    const THREE_DS_REQ_AUTH_METHOD__04 = '04';
    const THREE_DS_REQ_AUTH_METHOD__05 = '05';
    const THREE_DS_REQ_AUTH_METHOD__06 = '06';
    ...
    {
        $this->container['three_ds_req_auth_method'] = $data['three_ds_req_auth_method'] ?? null;
        $this->container['three_ds_req_auth_timestamp'] = $data['three_ds_req_auth_timestamp'] ?? null;
        $this->container['three_ds_req_auth_data'] = $data['three_ds_req_auth_data'] ?? null;
    }
     ...
     *
     * @param string|null $three_ds_req_auth_method three_ds_req_auth_method
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getThreeDsReqAuthMethodAllowableValues();
        if (!is_null($three_ds_req_auth_method) && !in_array($three_ds_req_auth_method, $allowedValues, true)) {
     ...
     *
     * @param \DateTime|null $three_ds_req_auth_timestamp three_ds_req_auth_timestamp
     *
     * @return self
     */
     ...
     *
     * @param string|null $three_ds_req_auth_data three_ds_req_auth_data
     *
     * @return self
     */
