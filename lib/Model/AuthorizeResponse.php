...
/**
 * AuthorizeResponse Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class AuthorizeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthorizeResponse';
    ...
    protected static $openAPITypes = [
        ...
        'acquirer_authorization_code' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'transaction_id' => null,
        'acquirer_authorization_code' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'acquirer_authorization_code' => 'acquirerAuthorizationCode'
    ];
    ...
    protected static $setters = [
        ...
        'acquirer_authorization_code' => 'setAcquirerAuthorizationCode'
    ];
    ...
    protected static $getters = [
        ...
        'acquirer_authorization_code' => 'getAcquirerAuthorizationCode'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['acquirer_authorization_code'] = $data['acquirer_authorization_code'] ?? null;
    }
     ...
     * Sets transaction_id
     *
     * @param string|null $transaction_id The transactionId to use for subsequent actions like settlement.
     *
     * @return self
     */
    ...
    /**
     * Gets acquirer_authorization_code
     *
     * @return string|null
     */
    public function getAcquirerAuthorizationCode()
    {
        return $this->container['acquirer_authorization_code'];
    }

    /**
     * Sets acquirer_authorization_code
     *
     * @param string|null $acquirer_authorization_code The authorization code returned by the acquirer or payment method provider.
     *
     * @return self
     */
    public function setAcquirerAuthorizationCode($acquirer_authorization_code)
    {
        $this->container['acquirer_authorization_code'] = $acquirer_authorization_code;
