...
/**
 * SaleReportResponse Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class SaleReportResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SaleReportResponse';
    ...
    const MATCH_RESULT_MATCHED = 'MATCHED';
    const MATCH_RESULT_CONFLICT = 'CONFLICT';
    const MATCH_RESULT_ALREADY_MATCHED = 'ALREADY_MATCHED';
    ...
    public function getMatchResultAllowableValues()
    {
        return [
            ...
            self::MATCH_RESULT_MATCHED,
            self::MATCH_RESULT_CONFLICT,
            self::MATCH_RESULT_ALREADY_MATCHED,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['match_result'] = $data['match_result'] ?? null;
    }
     ...
     * Sets sale_date
     *
     * @param \DateTime|null $sale_date The date when the sale took place
     *
     * @return self
     */
     ...
     * Sets reported_date
     *
     * @param \DateTime|null $reported_date The date when the sale was reported.
     *
     * @return self
     */
     ...
     * Sets match_result
     *
     * @param string|null $match_result The result after trying to match the reported sale.
     *
     * @return self
     */
