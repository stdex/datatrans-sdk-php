...
/**
 * WeChatDetail Class Doc Comment
 *
 * @category Class
 ...
 */
class WeChatDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WeChatDetail';
     ...
     * Sets prepay_id
     *
     * @param string|null $prepay_id prepay_id
     *
     * @return self
     */
