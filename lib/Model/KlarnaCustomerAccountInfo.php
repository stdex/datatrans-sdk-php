...
/**
 * KlarnaCustomerAccountInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class KlarnaCustomerAccountInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KlarnaCustomerAccountInfo';
     ...
     *
     * @param string|null $unique_identifier A unique name or number to identify the specific customer account. Max. 24 characters.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $registration_date The registration date and time of the account. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return self
     */
     ...
     * Sets last_modified
     *
     * @param \DateTime|null $last_modified The date and time the account was modified the last time. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return self
     */
