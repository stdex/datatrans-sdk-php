...
/**
 * ByjunoScreenRequest Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class ByjunoScreenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ByjunoScreenRequest';
    ...
    public function setRepaymentType($repayment_type)
    {
        ...
        if (!is_null($repayment_type) && ($repayment_type > 20)) {
            throw new \InvalidArgumentException('invalid value for $repayment_type when calling ByjunoScreenRequest., must be smaller than or equal to 20.');
        }
        if (!is_null($repayment_type) && ($repayment_type < 0)) {
            throw new \InvalidArgumentException('invalid value for $repayment_type when calling ByjunoScreenRequest., must be bigger than or equal to 0.');
        }
