...
/**
 * KlarnaPaymentHistoryFull Class Doc Comment
 *
 * @category Class
 ...
 */
class KlarnaPaymentHistoryFull implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KlarnaPaymentHistoryFull';
    ...
    protected static $openAPITypes = [
        ...
        'paid_purchases' => 'int',
        'total_amount_paid_purchases' => 'double',
        'last_paid_purchase' => '\DateTime',
        'first_paid_purchase' => '\DateTime'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'payment_option' => null,
        'paid_purchases' => 'int32',
        'total_amount_paid_purchases' => 'double',
        'last_paid_purchase' => 'date-time',
        'first_paid_purchase' => 'date-time'
    ];
    ...
    protected static $attributeMap = [
        ...
        'total_amount_paid_purchases' => 'totalAmountPaidPurchases',
        'last_paid_purchase' => 'lastPaidPurchase',
        'first_paid_purchase' => 'firstPaidPurchase'
    ];
    ...
    protected static $setters = [
        ...
        'paid_purchases' => 'setPaidPurchases',
        'total_amount_paid_purchases' => 'setTotalAmountPaidPurchases',
        'last_paid_purchase' => 'setLastPaidPurchase',
        'first_paid_purchase' => 'setFirstPaidPurchase'
    ];
    ...
    protected static $getters = [
        ...
        'paid_purchases' => 'getPaidPurchases',
        'total_amount_paid_purchases' => 'getTotalAmountPaidPurchases',
        'last_paid_purchase' => 'getLastPaidPurchase',
        'first_paid_purchase' => 'getFirstPaidPurchase'
    ];
    ...
    const PAYMENT_OPTION_DIRECT_BANKING = 'DIRECT_BANKING';
    const PAYMENT_OPTION_NON_KLARNA = 'NON_KLARNA';
    const PAYMENT_OPTION_CREDIT = 'CREDIT';
    ...
    public function getPaymentOptionAllowableValues()
    {
        return [
            ...
            self::PAYMENT_OPTION_NON_KLARNA,
            self::PAYMENT_OPTION_CREDIT,
    ...
    {
        $this->container['unique_identifier'] = $data['unique_identifier'] ?? null;
        $this->container['payment_option'] = $data['payment_option'] ?? null;
        $this->container['paid_purchases'] = $data['paid_purchases'] ?? null;
        $this->container['total_amount_paid_purchases'] = $data['total_amount_paid_purchases'] ?? null;
        $this->container['last_paid_purchase'] = $data['last_paid_purchase'] ?? null;
        $this->container['first_paid_purchase'] = $data['first_paid_purchase'] ?? null;
    }
     ...
     *
     * @param string|null $unique_identifier Unique name or number to identify the specific customer account. Max. 24 characters.
     *
     * @return self
     */
     ...
     * Sets payment_option
     *
     * @param string|null $payment_option The type of the line item
     *
     * @return self
     */
     ...
     * @return int|null
     */
    public function getPaidPurchases()
    {
        return $this->container['paid_purchases'];
    }

    /**
     * Sets paid_purchases
     *
     * @param int|null $paid_purchases The total number of successful purchases.
     *
     * @return self
     */
    public function setPaidPurchases($paid_purchases)
    {
        $this->container['paid_purchases'] = $paid_purchases;
     ...
     *
     * @param double|null $total_amount_paid_purchases The total amount of successful purchases (in local currency).
     *
     * @return self
     */
    ...
    /**
     * Gets last_paid_purchase
     *
     * @return \DateTime|null
     */
    public function getLastPaidPurchase()
    {
        return $this->container['last_paid_purchase'];
    }

    /**
     * Sets last_paid_purchase
     *
     * @param \DateTime|null $last_paid_purchase The date and time of the last paid purchase. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return self
     */
    public function setLastPaidPurchase($last_paid_purchase)
    {
        $this->container['last_paid_purchase'] = $last_paid_purchase;

        return $this;
    }

    /**
     * Gets first_paid_purchase
     *
     * @return \DateTime|null
     */
    public function getFirstPaidPurchase()
    {
        return $this->container['first_paid_purchase'];
    }

    /**
     * Sets first_paid_purchase
     *
     * @param \DateTime|null $first_paid_purchase The date and time of the first paid purchase. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return self
     */
    public function setFirstPaidPurchase($first_paid_purchase)
    {
        $this->container['first_paid_purchase'] = $first_paid_purchase;
