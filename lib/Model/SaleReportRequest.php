...
/**
 * SaleReportRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SaleReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SaleReportRequest';
     ...
     * Sets date
     *
     * @param \DateTime|null $date The date when the transaction happened.
     *
     * @return self
     */
