...
/**
 * CardInitRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CardInitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CardInitRequest';
    ...
    protected static $openAPITypes = [
        ...
        'expiry_month' => 'string',
        'expiry_year' => 'string',
        'create_alias_cvv' => 'bool',
        '_3_d' => '\Datatrans\Client\Model\CardInitThreeDSecure'
    ];
    ...
    protected static $attributeMap = [
        ...
        'create_alias_cvv' => 'createAliasCVV',
        '_3_d' => '3D'
    ];
    ...
    protected static $setters = [
        ...
        'create_alias_cvv' => 'setCreateAliasCvv',
        '_3_d' => 'set3D'
    ];
    ...
    protected static $getters = [
        ...
        'create_alias_cvv' => 'getCreateAliasCvv',
        '_3_d' => 'get3D'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['create_alias_cvv'] = $data['create_alias_cvv'] ?? null;
    ...
    public function setExpiryMonth($expiry_month)
    {
        if (!is_null($expiry_month) && (mb_strlen($expiry_month) > 2)) {
            throw new \InvalidArgumentException('invalid length for $expiry_month when calling CardInitRequest., must be smaller than or equal to 2.');
        }
        if (!is_null($expiry_month) && (mb_strlen($expiry_month) < 2)) {
            throw new \InvalidArgumentException('invalid length for $expiry_month when calling CardInitRequest., must be bigger than or equal to 2.');
        }
        if (!is_null($expiry_month) && (!preg_match("/\\d{2}/", $expiry_month))) {
            throw new \InvalidArgumentException("invalid value for $expiry_month when calling CardInitRequest., must conform to the pattern /\\d{2}/.");
        }
    ...
    public function setExpiryYear($expiry_year)
    {
        if (!is_null($expiry_year) && (mb_strlen($expiry_year) > 2)) {
            throw new \InvalidArgumentException('invalid length for $expiry_year when calling CardInitRequest., must be smaller than or equal to 2.');
        }
        if (!is_null($expiry_year) && (mb_strlen($expiry_year) < 2)) {
            throw new \InvalidArgumentException('invalid length for $expiry_year when calling CardInitRequest., must be bigger than or equal to 2.');
        }
        if (!is_null($expiry_year) && (!preg_match("/\\d{2}/", $expiry_year))) {
            throw new \InvalidArgumentException("invalid value for $expiry_year when calling CardInitRequest., must conform to the pattern /\\d{2}/.");
        }
    ...
    /**
     * Gets create_alias_cvv
     *
     * @return bool|null
     */
    public function getCreateAliasCvv()
    {
        return $this->container['create_alias_cvv'];
    }

    /**
     * Sets create_alias_cvv
     *
     * @param bool|null $create_alias_cvv Specifies whether a CVV alias should be created
     *
     * @return self
     */
    public function setCreateAliasCvv($create_alias_cvv)
    {
        $this->container['create_alias_cvv'] = $create_alias_cvv;
     ...
     * Gets _3_d
     *
     * @return \Datatrans\Client\Model\CardInitThreeDSecure|null
     */
     ...
     * Sets _3_d
     *
     * @param \Datatrans\Client\Model\CardInitThreeDSecure|null $_3_d _3_d
     *
     * @return self
     */
