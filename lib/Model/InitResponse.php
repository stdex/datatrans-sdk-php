...
/**
 * InitResponse Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class InitResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InitResponse';
    ...
    protected static $openAPITypes = [
        ...
        'mobile_token' => 'string',
        'wec' => '\Datatrans\Client\Model\WeChatResponse',
        '_3_d' => '\Datatrans\Client\Model\Secure3DResponse'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['mobile_token'] = $data['mobile_token'] ?? null;
     ...
     * Sets transaction_id
     *
     * @param string|null $transaction_id The `transactionId` to be used when using Redirect- or Lightbox Mode. If no further action happens with the `transactionId` after initialization, it will be invalidated after 30 minutes.
     *
     * @return self
     */
     ...
     * Sets mobile_token
     *
     * @param string|null $mobile_token Mobile token which is needed to initialize the Mobile SDKs.
     *
     * @return self
     */
     ...
     * Gets wec
     *
     * @return \Datatrans\Client\Model\WeChatResponse|null
     */
     ...
     * Sets wec
     *
     * @param \Datatrans\Client\Model\WeChatResponse|null $wec wec
     *
     * @return self
     */
     ...
     * Gets _3_d
     *
     * @return \Datatrans\Client\Model\Secure3DResponse|null
     */
     ...
     * Sets _3_d
     *
     * @param \Datatrans\Client\Model\Secure3DResponse|null $_3_d _3_d
     *
     * @return self
     */
