...
class RedirectRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'start_target' => 'setStartTarget',
        'return_target' => 'setReturnTarget',
        'method' => 'setMethod'
    ];
    ...
    protected static $getters = [
        ...
        'start_target' => 'getStartTarget',
        'return_target' => 'getReturnTarget',
        'method' => 'getMethod'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['error_url'] = $data['error_url'] ?? null;
        $this->container['start_target'] = $data['start_target'] ?? null;
        $this->container['return_target'] = $data['return_target'] ?? null;
        $this->container['method'] = $data['method'] ?? 'GET';
    }
     ...
     * Sets success_url
     *
     * @param string|null $success_url The URL where the customer gets redirected to if the transaction was successful.
     *
     * @return self
     */
     ...
     * Sets cancel_url
     *
     * @param string|null $cancel_url The URL where the customer gets redirected to if the transaction was canceled.
     *
     * @return self
     */
     ...
     * Sets error_url
     *
     * @param string|null $error_url The URL where the customer gets redirected to if an error occurred.
     *
     * @return self
     */
    ...
    {
        return $this->container['start_target'];
    }

    /**
     * Sets start_target
     *
     * @param string|null $start_target If the payment is started within an iframe or when using the Lightbox Mode, use value `_top`. This ensures a proper browser flow for payment methods who need a redirect.
     *
     * @return self
     */
    public function setStartTarget($start_target)
    {
        $this->container['start_target'] = $start_target;
    ...
    {
        return $this->container['return_target'];
    }

    /**
     * Sets return_target
     *
     * @param string|null $return_target If the payment is started within an iframe or when using the Lightbox Mode, use `_top` if the redirect URLs should be opened full screen when payment returns from a 3rd party (for example 3D).
     *
     * @return self
     */
    public function setReturnTarget($return_target)
    {
        $this->container['return_target'] = $return_target;
