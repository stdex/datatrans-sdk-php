...
class MerchantRiskIndicator implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const SHIP_INDICATOR__01 = '01';
    const SHIP_INDICATOR__02 = '02';
    const SHIP_INDICATOR__03 = '03';
    const SHIP_INDICATOR__04 = '04';
    const SHIP_INDICATOR__05 = '05';
    const SHIP_INDICATOR__06 = '06';
    const SHIP_INDICATOR__07 = '07';
    const DELIVERY_TIMEFRAME__01 = '01';
    const DELIVERY_TIMEFRAME__02 = '02';
    const DELIVERY_TIMEFRAME__03 = '03';
    const DELIVERY_TIMEFRAME__04 = '04';
    const REORDER_ITEMS_IND__01 = '01';
    const REORDER_ITEMS_IND__02 = '02';
    const PRE_ORDER_PURCHASE_IND__01 = '01';
    const PRE_ORDER_PURCHASE_IND__02 = '02';
     ...
     * @return string[]
     */
    public function getShipIndicatorAllowableValues()
    {
        return [
            self::SHIP_INDICATOR__01,
            self::SHIP_INDICATOR__02,
            self::SHIP_INDICATOR__03,
            self::SHIP_INDICATOR__04,
            self::SHIP_INDICATOR__05,
            self::SHIP_INDICATOR__06,
            self::SHIP_INDICATOR__07,
        ];
    }
    ...
    {
        return [
            self::DELIVERY_TIMEFRAME__01,
            self::DELIVERY_TIMEFRAME__02,
            self::DELIVERY_TIMEFRAME__03,
            self::DELIVERY_TIMEFRAME__04,
        ];
    }
     ...
     * @return string[]
     */
    public function getReorderItemsIndAllowableValues()
    {
        return [
            self::REORDER_ITEMS_IND__01,
            self::REORDER_ITEMS_IND__02,
        ];
    }
     ...
     * @return string[]
     */
    public function getPreOrderPurchaseIndAllowableValues()
    {
        return [
            self::PRE_ORDER_PURCHASE_IND__01,
            self::PRE_ORDER_PURCHASE_IND__02,
        ];
    }
    ...
    {
        $this->container['ship_indicator'] = $data['ship_indicator'] ?? null;
        $this->container['delivery_timeframe'] = $data['delivery_timeframe'] ?? null;
        $this->container['delivery_email_address'] = $data['delivery_email_address'] ?? null;
        $this->container['reorder_items_ind'] = $data['reorder_items_ind'] ?? null;
        $this->container['pre_order_purchase_ind'] = $data['pre_order_purchase_ind'] ?? null;
        $this->container['pre_order_date'] = $data['pre_order_date'] ?? null;
        $this->container['gift_card_amount'] = $data['gift_card_amount'] ?? null;
        $this->container['gift_card_curr'] = $data['gift_card_curr'] ?? null;
        $this->container['gift_card_count'] = $data['gift_card_count'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getShipIndicatorAllowableValues();
        if (!is_null($this->container['ship_indicator']) && !in_array($this->container['ship_indicator'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'ship_indicator', must be one of '%s'",
                $this->container['ship_indicator'],
        ...
        $allowedValues = $this->getReorderItemsIndAllowableValues();
        if (!is_null($this->container['reorder_items_ind']) && !in_array($this->container['reorder_items_ind'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'reorder_items_ind', must be one of '%s'",
                $this->container['reorder_items_ind'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getPreOrderPurchaseIndAllowableValues();
        if (!is_null($this->container['pre_order_purchase_ind']) && !in_array($this->container['pre_order_purchase_ind'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'pre_order_purchase_ind', must be one of '%s'",
                $this->container['pre_order_purchase_ind'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets ship_indicator
     *
     * @param string|null $ship_indicator ship_indicator
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getShipIndicatorAllowableValues();
        if (!is_null($ship_indicator) && !in_array($ship_indicator, $allowedValues, true)) {
     ...
     *
     * @param string|null $delivery_email_address delivery_email_address
     *
     * @return self
     */
     ...
     *
     * @param string|null $reorder_items_ind reorder_items_ind
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getReorderItemsIndAllowableValues();
        if (!is_null($reorder_items_ind) && !in_array($reorder_items_ind, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'reorder_items_ind', must be one of '%s'",
                    $reorder_items_ind,
     ...
     *
     * @param string|null $pre_order_purchase_ind pre_order_purchase_ind
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getPreOrderPurchaseIndAllowableValues();
        if (!is_null($pre_order_purchase_ind) && !in_array($pre_order_purchase_ind, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'pre_order_purchase_ind', must be one of '%s'",
     ...
     * Sets pre_order_date
     *
     * @param \DateTime|null $pre_order_date pre_order_date
     *
     * @return self
     */
     ...
     *
     * @param int|null $gift_card_amount gift_card_amount
     *
     * @return self
     */
     ...
     * Sets gift_card_curr
     *
     * @param string|null $gift_card_curr gift_card_curr
     *
     * @return self
     */
     ...
     *
     * @param string|null $gift_card_count gift_card_count
     *
     * @return self
     */
