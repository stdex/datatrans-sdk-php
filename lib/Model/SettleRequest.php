...
/**
 * SettleRequest Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class SettleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SettleRequest';
    ...
    protected static $openAPITypes = [
        ...
        'marketplace' => '\Datatrans\Client\Model\MarketPlaceSettle',
        'extensions' => 'object'
    ];
    ...
    public function setCurrency($currency)
    {
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling SettleRequest., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling SettleRequest., must be bigger than or equal to 3.');
        }
     ...
     * Sets refno
     *
     * @param string $refno The merchant's reference number. Most payment methods require you to have a unique reference for a transaction. In case you must change the reference number in settlement, ensure first it is supported by the dedicated payment method.
     *
     * @return self
     */
    public function setRefno($refno)
    {
        if ((mb_strlen($refno) > 20)) {
            throw new \InvalidArgumentException('invalid length for $refno when calling SettleRequest., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($refno) < 1)) {
            throw new \InvalidArgumentException('invalid length for $refno when calling SettleRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setRefno2($refno2)
    {
        if (!is_null($refno2) && (mb_strlen($refno2) > 17)) {
            throw new \InvalidArgumentException('invalid length for $refno2 when calling SettleRequest., must be smaller than or equal to 17.');
        }
        if (!is_null($refno2) && (mb_strlen($refno2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $refno2 when calling SettleRequest., must be bigger than or equal to 0.');
        }
     ...
     * Gets marketplace
     *
     * @return \Datatrans\Client\Model\MarketPlaceSettle|null
     */
     ...
     * Sets marketplace
     *
     * @param \Datatrans\Client\Model\MarketPlaceSettle|null $marketplace marketplace
     *
     * @return self
     */
     ...
     * Sets extensions
     *
     * @param object|null $extensions An object for additional data needed by some merchants for customized processes.
     *
     * @return self
     */
