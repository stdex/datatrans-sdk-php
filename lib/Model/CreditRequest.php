...
class CreditRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'refno' => 'string',
        'refno2' => 'string',
        'marketplace' => '\Datatrans\Client\Model\MarketPlaceCredit',
        'extensions' => 'object'
    ];
     ...
     * Sets amount
     *
     * @param int|null $amount The amount of the transaction in the currency’s smallest unit. For example use 1000 for CHF 10.00.
     *
     * @return self
     */
    ...
    public function setCurrency($currency)
    {
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreditRequest., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreditRequest., must be bigger than or equal to 3.');
        }
    ...
    public function setRefno($refno)
    {
        if ((mb_strlen($refno) > 20)) {
            throw new \InvalidArgumentException('invalid length for $refno when calling CreditRequest., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($refno) < 1)) {
            throw new \InvalidArgumentException('invalid length for $refno when calling CreditRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setRefno2($refno2)
    {
        if (!is_null($refno2) && (mb_strlen($refno2) > 17)) {
            throw new \InvalidArgumentException('invalid length for $refno2 when calling CreditRequest., must be smaller than or equal to 17.');
        }
        if (!is_null($refno2) && (mb_strlen($refno2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $refno2 when calling CreditRequest., must be bigger than or equal to 0.');
        }
     ...
     * Gets marketplace
     *
     * @return \Datatrans\Client\Model\MarketPlaceCredit|null
     */
     ...
     * Sets marketplace
     *
     * @param \Datatrans\Client\Model\MarketPlaceCredit|null $marketplace marketplace
     *
     * @return self
     */
