...
/**
 * PayPalDetail Class Doc Comment
 *
 * @category Class
 ...
 */
class PayPalDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayPalDetail';
     ...
     * Sets order_id
     *
     * @param string|null $order_id The PayPal orderId, if the transaction was a PayPal order.
     *
     * @return self
     */
     ...
     * Sets payer_id
     *
     * @param string|null $payer_id The PayPal payerId
     *
     * @return self
     */
