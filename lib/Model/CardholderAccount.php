...
class CardholderAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'acct_info' => '\Datatrans\Client\Model\CardholderAccountInformation',
        'acct_id' => 'string'
    ];
    ...
    {
        $this->container['card_expiry_date'] = $data['card_expiry_date'] ?? null;
        $this->container['acct_info'] = $data['acct_info'] ?? null;
        $this->container['acct_id'] = $data['acct_id'] ?? null;
    }
     ...
     *
     * @param string|null $card_expiry_date card_expiry_date
     *
     * @return self
     */
     ...
     * Gets acct_info
     *
     * @return \Datatrans\Client\Model\CardholderAccountInformation|null
     */
     ...
     * Sets acct_info
     *
     * @param \Datatrans\Client\Model\CardholderAccountInformation|null $acct_info acct_info
     *
     * @return self
     */
     ...
     * Sets acct_id
     *
     * @param string|null $acct_id acct_id
     *
     * @return self
     */
