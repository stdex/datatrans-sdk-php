...
/**
 * AmazonFraudContext Class Doc Comment
 *
 * @category Class
 ...
 */
class AmazonFraudContext implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AmazonFraudContext';
    ...
    protected static $openAPITypes = [
        'airline_meta_data' => '\Datatrans\Client\Model\AirlineMetaData',
        'accommodation_meta_data' => '\Datatrans\Client\Model\AccommodationMetaData',
        'buyer_meta_data' => '\Datatrans\Client\Model\BuyerMetaData',
        'order_meta_data' => '\Datatrans\Client\Model\OrderMetaData'
    ];
    ...
    protected static $openAPIFormats = [
        'airline_meta_data' => null,
        'accommodation_meta_data' => null,
        'buyer_meta_data' => null,
    ...
    protected static $attributeMap = [
        'airline_meta_data' => 'airlineMetaData',
        'accommodation_meta_data' => 'accommodationMetaData',
        'buyer_meta_data' => 'buyerMetaData',
    ...
    protected static $setters = [
        'airline_meta_data' => 'setAirlineMetaData',
        'accommodation_meta_data' => 'setAccommodationMetaData',
        'buyer_meta_data' => 'setBuyerMetaData',
        'order_meta_data' => 'setOrderMetaData'
    ];
    ...
    protected static $getters = [
        'airline_meta_data' => 'getAirlineMetaData',
        'accommodation_meta_data' => 'getAccommodationMetaData',
        'buyer_meta_data' => 'getBuyerMetaData',
        'order_meta_data' => 'getOrderMetaData'
    ];
    ...
    {
        $this->container['airline_meta_data'] = $data['airline_meta_data'] ?? null;
        $this->container['accommodation_meta_data'] = $data['accommodation_meta_data'] ?? null;
        $this->container['buyer_meta_data'] = $data['buyer_meta_data'] ?? null;
        $this->container['order_meta_data'] = $data['order_meta_data'] ?? null;
    }
    ...
    /**
     * Gets airline_meta_data
     *
     * @return \Datatrans\Client\Model\AirlineMetaData|null
     */
    public function getAirlineMetaData()
    {
        return $this->container['airline_meta_data'];
    }

    /**
     * Sets airline_meta_data
     *
     * @param \Datatrans\Client\Model\AirlineMetaData|null $airline_meta_data airline_meta_data
     *
     * @return self
     */
    public function setAirlineMetaData($airline_meta_data)
    {
        $this->container['airline_meta_data'] = $airline_meta_data;

        return $this;
    }

    /**
     * Gets accommodation_meta_data
     *
     * @return \Datatrans\Client\Model\AccommodationMetaData|null
     */
    public function getAccommodationMetaData()
    {
        return $this->container['accommodation_meta_data'];
    }

    /**
     * Sets accommodation_meta_data
     *
     * @param \Datatrans\Client\Model\AccommodationMetaData|null $accommodation_meta_data accommodation_meta_data
     *
     * @return self
     */
    public function setAccommodationMetaData($accommodation_meta_data)
    {
        $this->container['accommodation_meta_data'] = $accommodation_meta_data;

        return $this;
    }

    /**
     * Gets buyer_meta_data
     *
     * @return \Datatrans\Client\Model\BuyerMetaData|null
     */
    public function getBuyerMetaData()
    {
        return $this->container['buyer_meta_data'];
    }

    /**
     * Sets buyer_meta_data
     *
     * @param \Datatrans\Client\Model\BuyerMetaData|null $buyer_meta_data buyer_meta_data
     *
     * @return self
     */
    public function setBuyerMetaData($buyer_meta_data)
    {
        $this->container['buyer_meta_data'] = $buyer_meta_data;

        return $this;
    }

    /**
     * Gets order_meta_data
     *
     * @return \Datatrans\Client\Model\OrderMetaData|null
     */
    public function getOrderMetaData()
    {
        return $this->container['order_meta_data'];
    }

    /**
     * Sets order_meta_data
     *
     * @param \Datatrans\Client\Model\OrderMetaData|null $order_meta_data order_meta_data
     *
     * @return self
     */
    public function setOrderMetaData($order_meta_data)
    {
        $this->container['order_meta_data'] = $order_meta_data;
