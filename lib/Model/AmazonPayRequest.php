...
/**
 * AmazonPayRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class AmazonPayRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AmazonPayRequest';
    ...
    protected static $openAPITypes = [
        'seller_note' => 'string',
        'fraud_context' => '\Datatrans\Client\Model\AmazonFraudContext'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['fraud_context'] = $data['fraud_context'] ?? null;
    }
     ...
     * Sets seller_note
     *
     * @param string|null $seller_note Represents a description of the billing agreement that is shown in emails to the buyer and on the Amazon Pay website.
     *
     * @return self
     */
     ...
     * Gets fraud_context
     *
     * @return \Datatrans\Client\Model\AmazonFraudContext|null
     */
    public function getFraudContext()
    {
        return $this->container['fraud_context'];
    }

    /**
     * Sets fraud_context
     *
     * @param \Datatrans\Client\Model\AmazonFraudContext|null $fraud_context fraud_context
     *
     * @return self
     */
    public function setFraudContext($fraud_context)
    {
        $this->container['fraud_context'] = $fraud_context;
