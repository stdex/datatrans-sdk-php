...
class Article implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'tax_percent' => 'double',
        'tax_amount' => 'int',
        'price_without_vat' => 'int',
        'single_item_price' => 'int',
        'single_item_price_without_vat' => 'int',
        'discount' => 'int',
        'type' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'tax_percent' => 'double',
        'tax_amount' => 'int64',
        'price_without_vat' => 'int64',
        'single_item_price' => 'int64',
        'single_item_price_without_vat' => 'int64',
        'discount' => 'int64',
        'type' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'single_item_price_without_vat' => 'singleItemPriceWithoutVAT',
        'discount' => 'discount',
        'type' => 'type'
    ];
    ...
    protected static $setters = [
        ...
        'single_item_price' => 'setSingleItemPrice',
        'single_item_price_without_vat' => 'setSingleItemPriceWithoutVat',
    ...
    protected static $getters = [
        ...
        'single_item_price' => 'getSingleItemPrice',
        'single_item_price_without_vat' => 'getSingleItemPriceWithoutVat',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['price_without_vat'] = $data['price_without_vat'] ?? null;
        $this->container['single_item_price'] = $data['single_item_price'] ?? null;
        $this->container['single_item_price_without_vat'] = $data['single_item_price_without_vat'] ?? null;
     ...
     * Sets price_gross
     *
     * @param int|null $price_gross price_gross
     *
     * @return self
     */
     ...
     *
     * @param int|null $price_without_vat price_without_vat
     *
     * @return self
     */
    ...
    /**
     * Gets single_item_price
     *
     * @return int|null
     */
    public function getSingleItemPrice()
    {
        return $this->container['single_item_price'];
    }

    /**
     * Sets single_item_price
     *
     * @param int|null $single_item_price single_item_price
     *
     * @return self
     */
    public function setSingleItemPrice($single_item_price)
    {
        $this->container['single_item_price'] = $single_item_price;

        return $this;
    }

    /**
     * Gets single_item_price_without_vat
     *
     * @return int|null
     */
    public function getSingleItemPriceWithoutVat()
    {
        return $this->container['single_item_price_without_vat'];
    }

    /**
     * Sets single_item_price_without_vat
     *
     * @param int|null $single_item_price_without_vat single_item_price_without_vat
     *
     * @return self
     */
    public function setSingleItemPriceWithoutVat($single_item_price_without_vat)
    {
        $this->container['single_item_price_without_vat'] = $single_item_price_without_vat;
