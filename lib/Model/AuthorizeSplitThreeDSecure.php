...
/**
 * AuthorizeSplitThreeDSecure Class Doc Comment
 *
 * @category Class
 ...
 */
class AuthorizeSplitThreeDSecure implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthorizeSplitThreeDSecure';
