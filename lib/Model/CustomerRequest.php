...
class CustomerRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'type' => 'setType',
        'name' => 'setName',
        'company_legal_form' => 'setCompanyLegalForm',
    ...
    protected static $getters = [
        ...
        'type' => 'getType',
        'name' => 'getName',
        'company_legal_form' => 'getCompanyLegalForm',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['company_legal_form'] = $data['company_legal_form'] ?? null;
        $this->container['company_register_number'] = $data['company_register_number'] ?? null;
     ...
     * Sets id
     *
     * @param string|null $id Unique customer identifier
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title Something like `Ms` or `Mrs`
     *
     * @return self
     */
     ...
     * Sets street2
     *
     * @param string|null $street2 Additional street information. For example: '3rd floor'
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country 2 letter ISO 3166-1 alpha-2 country code
     *
     * @return self
     */
     ...
     * Sets zip_code
     *
     * @param string|null $zip_code Zip code of the customer.
     *
     * @return self
     */
     ...
     * Sets cell_phone
     *
     * @param string|null $cell_phone Cell Phone number of the customer.
     *
     * @return self
     */
     ...
     * Sets gender
     *
     * @param string|null $gender Gender of the customer. `female` or `male`.
     *
     * @return self
     */
     ...
     * Sets birth_date
     *
     * @param \DateTime|null $birth_date The birth date of the customer. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (`YYYY-MM-DD`).
     *
     * @return self
     */
     ...
     * Sets language
     *
     * @param string|null $language The language of the customer.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type `P` or `C` depending on whether the customer is private or a company. If `C`, the fields `name` and `companyRegisterNumber` are required
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the company. Only applicable if `type=C`
     *
     * @return self
     */
    ...
    /**
     * Gets company_legal_form
     *
     * @return string|null
     */
    public function getCompanyLegalForm()
    {
        return $this->container['company_legal_form'];
    }

    /**
     * Sets company_legal_form
     *
     * @param string|null $company_legal_form The legal form of the company (AG, GmbH, ...)
     *
     * @return self
     */
    public function setCompanyLegalForm($company_legal_form)
    {
        $this->container['company_legal_form'] = $company_legal_form;
     ...
     *
     * @param string|null $company_register_number The register number of the company. Only applicable if `type=C`
     *
     * @return self
     */
