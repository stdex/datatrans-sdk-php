...
/**
 * AccardaRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class AccardaRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccardaRequest';
    ...
    protected static $openAPITypes = [
        'mode' => 'string',
        'installment' => '\Datatrans\Client\Model\Installment',
        'channel' => 'string',
        'street_split' => 'bool',
        'screening_only' => 'bool',
        'order_number' => 'string',
        'coupon_amount' => 'int',
        'attachments' => '\Datatrans\Client\Model\AccardaAttachment[]'
    ];
    ...
    protected static $setters = [
        ...
        'channel' => 'setChannel',
        'street_split' => 'setStreetSplit',
        'screening_only' => 'setScreeningOnly',
    ...
    protected static $getters = [
        ...
        'channel' => 'getChannel',
        'street_split' => 'getStreetSplit',
        'screening_only' => 'getScreeningOnly',
    ...
    const MODE_INSTALLMENT = 'installment';
    const CHANNEL_EMAIL = 'email';
    const CHANNEL__PRINT = 'print';
    const CHANNEL_INSURANCE = 'insurance';
    ...
    {
        $this->container['mode'] = $data['mode'] ?? 'invoice';
        $this->container['installment'] = $data['installment'] ?? null;
        $this->container['channel'] = $data['channel'] ?? null;
        $this->container['street_split'] = $data['street_split'] ?? false;
        $this->container['screening_only'] = $data['screening_only'] ?? false;
        $this->container['order_number'] = $data['order_number'] ?? null;
        $this->container['coupon_amount'] = $data['coupon_amount'] ?? null;
     ...
     * Sets mode
     *
     * @param string $mode Defines the type of the payment
     *
     * @return self
     */
     ...
     * Gets installment
     *
     * @return \Datatrans\Client\Model\Installment|null
     */
     ...
     * Sets installment
     *
     * @param \Datatrans\Client\Model\Installment|null $installment installment
     *
     * @return self
     */
     ...
     * Sets channel
     *
     * @param string|null $channel The invoice channel
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getStreetSplit()
    {
        return $this->container['street_split'];
    }

    /**
     * Sets street_split
     *
     * @param bool|null $street_split If `true` the value of `customer.street` will be split into street nameand street number
     *
     * @return self
     */
    public function setStreetSplit($street_split)
    {
        $this->container['street_split'] = $street_split;
     ...
     * @return bool|null
     */
    public function getScreeningOnly()
    {
        return $this->container['screening_only'];
    }

    /**
     * Sets screening_only
     *
     * @param bool|null $screening_only If `true` only a pre-screening request is done.
     *
     * @return self
     */
    public function setScreeningOnly($screening_only)
    {
        $this->container['screening_only'] = $screening_only;
     ...
     * Sets order_number
     *
     * @param string|null $order_number Accarda reference number, mainly useful for B2B orders where the company doing the order might have their own ID to identify the invoice later on within their own systems.
     *
     * @return self
     */
     ...
     * Sets coupon_amount
     *
     * @param int|null $coupon_amount Amount in the basket payed by coupon or other payment instruments.
     *
     * @return self
     */
     ...
     * Gets attachments
     *
     * @return \Datatrans\Client\Model\AccardaAttachment[]|null
     */
     ...
     * Sets attachments
     *
     * @param \Datatrans\Client\Model\AccardaAttachment[]|null $attachments List of base64 encoded attachments
     *
     * @return self
     */
