...
/**
 * PayPalValidateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PayPalValidateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayPalValidateRequest';
