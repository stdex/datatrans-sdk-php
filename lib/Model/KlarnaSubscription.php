...
/**
 * KlarnaSubscription Class Doc Comment
 *
 * @category Class
 ...
 */
class KlarnaSubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KlarnaSubscription';
     ...
     * Sets name
     *
     * @param string|null $name The name of the product of the subscription
     *
     * @return self
     */
     ...
     * Sets start
     *
     * @param \DateTime|null $start The start date and time of the subscription. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return self
     */
     ...
     * Sets end
     *
     * @param \DateTime|null $end The end date and time of the subscription. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return self
     */
     ...
     * Sets auto_renewal
     *
     * @param bool|null $auto_renewal `true` if the subscription will be auto renewed upon expiry.
     *
     * @return self
     */
