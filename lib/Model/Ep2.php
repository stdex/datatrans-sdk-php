 ...
 */
class Ep2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Ep2';
    ...
    {
        $this->container['trm_id'] = $data['trm_id'] ?? null;
        $this->container['trx_seq_cnt'] = $data['trx_seq_cnt'] ?? null;
        $this->container['aid'] = $data['aid'] ?? null;
        $this->container['amt_auth'] = $data['amt_auth'] ?? null;
        $this->container['trx_date'] = $data['trx_date'] ?? null;
        $this->container['trx_time'] = $data['trx_time'] ?? null;
        $this->container['pan'] = $data['pan'] ?? null;
        $this->container['app_pan_enc'] = $data['app_pan_enc'] ?? null;
        $this->container['issuer_code'] = $data['issuer_code'] ?? null;
        $this->container['act_seq_cnt'] = $data['act_seq_cnt'] ?? null;
        $this->container['trx_ref_num'] = $data['trx_ref_num'] ?? null;
        $this->container['trx_type_ext'] = $data['trx_type_ext'] ?? null;
        $this->container['brand'] = $data['brand'] ?? null;
        $this->container['auth_code'] = $data['auth_code'] ?? null;
        $this->container['static_key_index'] = $data['static_key_index'] ?? null;
        $this->container['trx_curr_c'] = $data['trx_curr_c'] ?? null;
    }
     ...
     * Sets trm_id
     *
     * @param string|null $trm_id The terminal ID
     *
     * @return self
     */
     ...
     * Sets trx_seq_cnt
     *
     * @param string|null $trx_seq_cnt The transaction Sequence Count
     *
     * @return self
     */
     ...
     * Sets aid
     *
     * @param string|null $aid The application Identifier
     *
     * @return self
     */
     ...
     * Sets amt_auth
     *
     * @param string|null $amt_auth The authorized amount
     *
     * @return self
     */
     ...
     * Sets trx_date
     *
     * @param string|null $trx_date The date of the processing
     *
     * @return self
     */
     ...
     * Sets trx_time
     *
     * @param string|null $trx_time The time of the processing
     *
     * @return self
     */
     ...
     * Sets app_pan_enc
     *
     * @param string|null $app_pan_enc The encrypted cardholder account number
     *
     * @return self
     */
     ...
     * Sets issuer_code
     *
     * @param string|null $issuer_code The issuer code
     *
     * @return self
     */
     ...
     * Sets act_seq_cnt
     *
     * @param int|null $act_seq_cnt The activation sequence count
     *
     * @return self
     */
     ...
     * Sets trx_ref_num
     *
     * @param string|null $trx_ref_num The transaction reference number
     *
     * @return self
     */
     ...
     * Sets trx_type_ext
     *
     * @param string|null $trx_type_ext The transaction type extension
     *
     * @return self
     */
     ...
     *
     * @param string|null $static_key_index The static key index
     *
     * @return self
     */
     ...
     * Sets trx_curr_c
     *
     * @param string|null $trx_curr_c The transaction currency code
     *
     * @return self
     */
