...
/**
 * ReconciliationsError Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReconciliationsError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReconciliationsError';
    ...
    protected static $openAPITypes = [
        'code' => '\Datatrans\Client\Model\ReconciliationsErrorCode',
        'message' => 'string'
    ];
     ...
     * Gets code
     *
     * @return \Datatrans\Client\Model\ReconciliationsErrorCode|null
     */
     ...
     * Sets code
     *
     * @param \Datatrans\Client\Model\ReconciliationsErrorCode|null $code code
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message A human readable message indicating what went wrong.
     *
     * @return self
     */
