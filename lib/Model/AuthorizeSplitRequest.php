...
/**
 * AuthorizeSplitRequest Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class AuthorizeSplitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthorizeSplitRequest';
    ...
    protected static $openAPITypes = [
        ...
        'auto_settle' => 'bool',
        'cdm' => 'object',
        '_3_d' => '\Datatrans\Client\Model\AuthorizeSplitThreeDSecure'
    ];
    ...
    public function setRefno2($refno2)
    {
        if (!is_null($refno2) && (mb_strlen($refno2) > 17)) {
            throw new \InvalidArgumentException('invalid length for $refno2 when calling AuthorizeSplitRequest., must be smaller than or equal to 17.');
        }
        if (!is_null($refno2) && (mb_strlen($refno2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $refno2 when calling AuthorizeSplitRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets cdm
     *
     * @param object|null $cdm CyberSource specific parameters. Use the same properties as you would for direct CyberSource requests.
     *
     * @return self
     */
     ...
     * Gets _3_d
     *
     * @return \Datatrans\Client\Model\AuthorizeSplitThreeDSecure|null
     */
     ...
     * Sets _3_d
     *
     * @param \Datatrans\Client\Model\AuthorizeSplitThreeDSecure|null $_3_d _3_d
     *
     * @return self
     */
