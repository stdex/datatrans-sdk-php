...
class OrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'articles' => '\Datatrans\Client\Model\Article[]',
        'tax_amount' => 'int',
        'shipping_amount' => 'int',
        'discount_amount' => 'int'
    ];
     ...
     * Gets articles
     *
     * @return \Datatrans\Client\Model\Article[]|null
     */
     ...
     * Sets articles
     *
     * @param \Datatrans\Client\Model\Article[]|null $articles articles
     *
     * @return self
     */
     ...
     *
     * @param int|null $shipping_amount shipping_amount
     *
     * @return self
     */
