...
class Ticket implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'legs' => '\Datatrans\Client\Model\Leg[]'
    ];
    ...
    protected static $setters = [
        ...
        'description_code' => 'setDescriptionCode',
        'legs' => 'setLegs'
    ];
    ...
    protected static $getters = [
        ...
        'description_code' => 'getDescriptionCode',
        'legs' => 'getLegs'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['description_code'] = $data['description_code'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['passenger_name']) && (mb_strlen($this->container['passenger_name']) < 1)) {
            $invalidProperties[] = "invalid value for 'passenger_name', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['description_code']) && (mb_strlen($this->container['description_code']) > 1)) {
            $invalidProperties[] = "invalid value for 'description_code', the character length must be smaller than or equal to 1.";
        }

        if (!is_null($this->container['description_code']) && (mb_strlen($this->container['description_code']) < 1)) {
            $invalidProperties[] = "invalid value for 'description_code', the character length must be bigger than or equal to 1.";
        }
     ...
     * Sets ticket_number
     *
     * @param string|null $ticket_number the number of the ticket
     *
     * @return self
     */
     ...
     * Sets passenger_name
     *
     * @param string|null $passenger_name Name of passenger or person to whom the ticket was issued
     *
     * @return self
     */
    public function setPassengerName($passenger_name)
    {
        if (!is_null($passenger_name) && (mb_strlen($passenger_name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $passenger_name when calling Ticket., must be smaller than or equal to 25.');
        }
        if (!is_null($passenger_name) && (mb_strlen($passenger_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $passenger_name when calling Ticket., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets description_code
     *
     * @return string|null
     */
    public function getDescriptionCode()
    {
        return $this->container['description_code'];
    }

    /**
     * Sets description_code
     *
     * @param string|null $description_code Description code
     *
     * @return self
     */
    public function setDescriptionCode($description_code)
    {
        if (!is_null($description_code) && (mb_strlen($description_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $description_code when calling Ticket., must be smaller than or equal to 1.');
        }
        if (!is_null($description_code) && (mb_strlen($description_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description_code when calling Ticket., must be bigger than or equal to 1.');
        }

        $this->container['description_code'] = $description_code;
     ...
     * Gets legs
     *
     * @return \Datatrans\Client\Model\Leg[]|null
     */
     ...
     * Sets legs
     *
     * @param \Datatrans\Client\Model\Leg[]|null $legs List of ticket's legs
     *
     * @return self
     */
