...
class Action implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'date' => '\DateTime',
        'success' => 'bool',
        'marketplace' => '\Datatrans\Client\Model\MarketPlace',
        'ip' => 'string'
    ];
    ...
    const SOURCE_LIGHTBOX = 'lightbox';
    const SOURCE_LINK = 'link';
    const SOURCE_REDIRECT = 'redirect';
    const SOURCE_SECURE_FIELDS = 'secure_fields';
    const SOURCE_SYSTEM = 'system';
    const SOURCE_WEB = 'web';
    const SOURCE_WEB_HIDDEN = 'web_hidden';
    ...
    public function getSourceAllowableValues()
    {
        return [
            ...
            self::SOURCE_INLINE,
            self::SOURCE_IOS,
            self::SOURCE_LIGHTBOX,
            self::SOURCE_LINK,
            self::SOURCE_REDIRECT,
            self::SOURCE_SECURE_FIELDS,
            self::SOURCE_SYSTEM,
            self::SOURCE_WEB,
            self::SOURCE_WEB_HIDDEN,
            self::SOURCE_UNKNOWN,
        ];
    }
     ...
     * Sets auto_settle
     *
     * @param bool|null $auto_settle Indicates if auto settlement was used. Only applicable if action was `authorize`
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param int|null $amount The amount used.
     *
     * @return self
     */
     ...
     * Sets source
     *
     * @param string|null $source From where the action originated.
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime|null $date Date when the action was performed.
     *
     * @return self
     */
     ...
     * Sets success
     *
     * @param bool|null $success Whether the action was successful or not.
     *
     * @return self
     */
     ...
     * Gets marketplace
     *
     * @return \Datatrans\Client\Model\MarketPlace|null
     */
     ...
     * Sets marketplace
     *
     * @param \Datatrans\Client\Model\MarketPlace|null $marketplace marketplace
     *
     * @return self
     */
     ...
     * Sets ip
     *
     * @param string|null $ip The IP address from where the action originated from.
     *
     * @return self
     */
