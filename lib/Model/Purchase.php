...
class Purchase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'merchant_risk_indicator' => '\Datatrans\Client\Model\MerchantRiskIndicator',
        'purchase_amount' => 'int',
        'purchase_currency' => 'string',
        'purchase_exponent' => 'int',
    ...
    protected static $attributeMap = [
        ...
        'purchase_exponent' => 'purchaseExponent',
    ...
    protected static $setters = [
        ...
        'purchase_exponent' => 'setPurchaseExponent',
    ...
    protected static $getters = [
        ...
        'purchase_exponent' => 'getPurchaseExponent',
    ...
    {
        $this->container['purchase_instal_data'] = $data['purchase_instal_data'] ?? null;
        $this->container['merchant_risk_indicator'] = $data['merchant_risk_indicator'] ?? null;
        $this->container['purchase_amount'] = $data['purchase_amount'] ?? null;
        $this->container['purchase_currency'] = $data['purchase_currency'] ?? null;
        $this->container['purchase_exponent'] = $data['purchase_exponent'] ?? null;
        $this->container['purchase_date'] = $data['purchase_date'] ?? null;
        $this->container['recurring_expiry'] = $data['recurring_expiry'] ?? null;
        $this->container['recurring_frequency'] = $data['recurring_frequency'] ?? null;
     ...
     *
     * @param int|null $purchase_instal_data purchase_instal_data
     *
     * @return self
     */
     ...
     *
     * @return \Datatrans\Client\Model\MerchantRiskIndicator|null
     */
     ...
     *
     * @param \Datatrans\Client\Model\MerchantRiskIndicator|null $merchant_risk_indicator merchant_risk_indicator
     *
     * @return self
     */
     ...
     *
     * @param int|null $purchase_amount purchase_amount
     *
     * @return self
     */
    ...
    /**
     * Gets purchase_exponent
     *
     * @return int|null
     */
    public function getPurchaseExponent()
    {
        return $this->container['purchase_exponent'];
    }

    /**
     * Sets purchase_exponent
     *
     * @param int|null $purchase_exponent purchase_exponent
     *
     * @return self
     */
    public function setPurchaseExponent($purchase_exponent)
    {
        $this->container['purchase_exponent'] = $purchase_exponent;
     ...
     *
     * @param \DateTime|null $recurring_expiry recurring_expiry
     *
     * @return self
     */
     ...
     *
     * @param int|null $recurring_frequency recurring_frequency
     *
     * @return self
     */
