...
/**
 * CancelDetail Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class CancelDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CancelDetail';
    ...
    {
        $this->container['reversal'] = $data['reversal'] ?? null;
    }
     ...
     * Sets reversal
     *
     * @param bool|null $reversal Whether the transaction was reversed on acquirer side.
     *
     * @return self
     */
