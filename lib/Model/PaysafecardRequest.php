...
/**
 * PaysafecardRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PaysafecardRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaysafecardRequest';
    ...
    protected static $setters = [
        'merchant_client_id' => 'setMerchantClientId'
    ];
    ...
    protected static $getters = [
        'merchant_client_id' => 'getMerchantClientId'
    ];
    ...
    {
        $this->container['merchant_client_id'] = $data['merchant_client_id'] ?? null;
    }
