...
/**
 * KlarnaAuthorizeRequest Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class KlarnaAuthorizeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KlarnaAuthorizeRequest';
    ...
    protected static $openAPITypes = [
        ...
        'events' => '\Datatrans\Client\Model\KlarnaEvent[]',
        'subscriptions' => '\Datatrans\Client\Model\KlarnaSubscription[]',
        'account_infos' => '\Datatrans\Client\Model\KlarnaCustomerAccountInfo[]',
        'history_simple' => '\Datatrans\Client\Model\KlarnaPaymentHistorySimple[]',
        'history_full' => '\Datatrans\Client\Model\KlarnaPaymentHistoryFull[]',
        'alias' => 'string'
    ];
    ...
    protected static $setters = [
        'sub_payment_method' => 'setSubPaymentMethod',
        'events' => 'setEvents',
        'subscriptions' => 'setSubscriptions',
        'account_infos' => 'setAccountInfos',
        'history_simple' => 'setHistorySimple',
        'history_full' => 'setHistoryFull',
        'alias' => 'setAlias'
    ];
    ...
    protected static $getters = [
        'sub_payment_method' => 'getSubPaymentMethod',
        'events' => 'getEvents',
        'subscriptions' => 'getSubscriptions',
        'account_infos' => 'getAccountInfos',
        'history_simple' => 'getHistorySimple',
        'history_full' => 'getHistoryFull',
        'alias' => 'getAlias'
    ];
    ...
    const SUB_PAYMENT_METHOD_PAY_NOW = 'pay_now';
    const SUB_PAYMENT_METHOD_PAY_LATER = 'pay_later';
    const SUB_PAYMENT_METHOD_PAY_OVER_TIME = 'pay_over_time';
    const SUB_PAYMENT_METHOD_DIRECT_DEBIT = 'direct_debit';
    const SUB_PAYMENT_METHOD_DIRECT_BANK_TRANSFER = 'direct_bank_transfer';
     ...
     * @return string[]
     */
    public function getSubPaymentMethodAllowableValues()
    {
        return [
            self::SUB_PAYMENT_METHOD_PAY_NOW,
            self::SUB_PAYMENT_METHOD_PAY_LATER,
            self::SUB_PAYMENT_METHOD_PAY_OVER_TIME,
            self::SUB_PAYMENT_METHOD_DIRECT_DEBIT,
            self::SUB_PAYMENT_METHOD_DIRECT_BANK_TRANSFER,
        ];
    }
    ...
    {
        $this->container['sub_payment_method'] = $data['sub_payment_method'] ?? null;
        $this->container['events'] = $data['events'] ?? null;
        $this->container['subscriptions'] = $data['subscriptions'] ?? null;
        $this->container['account_infos'] = $data['account_infos'] ?? null;
        $this->container['history_simple'] = $data['history_simple'] ?? null;
        $this->container['history_full'] = $data['history_full'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getSubPaymentMethodAllowableValues();
        if (!is_null($this->container['sub_payment_method']) && !in_array($this->container['sub_payment_method'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'sub_payment_method', must be one of '%s'",
                $this->container['sub_payment_method'],
    ...
    /**
     * Gets sub_payment_method
     *
     * @return string|null
     */
    public function getSubPaymentMethod()
    {
        return $this->container['sub_payment_method'];
    }

    /**
     * Sets sub_payment_method
     *
     * @param string|null $sub_payment_method The Klarna specific payment method used for the transaction.
     *
     * @return self
     */
    public function setSubPaymentMethod($sub_payment_method)
    {
        $allowedValues = $this->getSubPaymentMethodAllowableValues();
        if (!is_null($sub_payment_method) && !in_array($sub_payment_method, $allowedValues, true)) {
        ...
        $this->container['sub_payment_method'] = $sub_payment_method;
     ...
     * Gets events
     *
     * @return \Datatrans\Client\Model\KlarnaEvent[]|null
     */
     ...
     * Sets events
     *
     * @param \Datatrans\Client\Model\KlarnaEvent[]|null $events A list of Klarna events.
     *
     * @return self
     */
     ...
     * Gets subscriptions
     *
     * @return \Datatrans\Client\Model\KlarnaSubscription[]|null
     */
     ...
     * Sets subscriptions
     *
     * @param \Datatrans\Client\Model\KlarnaSubscription[]|null $subscriptions A list of Klarna subscriptions.
     *
     * @return self
     */
     ...
     * Gets account_infos
     *
     * @return \Datatrans\Client\Model\KlarnaCustomerAccountInfo[]|null
     */
     ...
     * Sets account_infos
     *
     * @param \Datatrans\Client\Model\KlarnaCustomerAccountInfo[]|null $account_infos A list of Klarna customer account infos.
     *
     * @return self
     */
     ...
     * Gets history_simple
     *
     * @return \Datatrans\Client\Model\KlarnaPaymentHistorySimple[]|null
     */
    public function getHistorySimple()
    {
        return $this->container['history_simple'];
    }

    /**
     * Sets history_simple
     *
     * @param \Datatrans\Client\Model\KlarnaPaymentHistorySimple[]|null $history_simple A list of simple history entries
     *
     * @return self
     */
    public function setHistorySimple($history_simple)
    {
        $this->container['history_simple'] = $history_simple;
     ...
     * Gets history_full
     *
     * @return \Datatrans\Client\Model\KlarnaPaymentHistoryFull[]|null
     */
    public function getHistoryFull()
    {
        return $this->container['history_full'];
    }

    /**
     * Sets history_full
     *
     * @param \Datatrans\Client\Model\KlarnaPaymentHistoryFull[]|null $history_full A list of full history entries
     *
     * @return self
     */
    public function setHistoryFull($history_full)
    {
        $this->container['history_full'] = $history_full;
     ...
     * Sets alias
     *
     * @param string $alias Alias received for example from a previous transaction if `option.createAlias: true` was used. In order to retrieve the alias from a previous transaction, use the [Status API](#operation/status).
     *
     * @return self
     */
