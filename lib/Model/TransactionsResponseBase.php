...
/**
 * TransactionsResponseBase Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class TransactionsResponseBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionsResponseBase';
    ...
    protected static $openAPITypes = [
        'error' => '\Datatrans\Client\Model\TransactionsError'
    ];
     ...
     * Gets error
     *
     * @return \Datatrans\Client\Model\TransactionsError|null
     */
     ...
     * Sets error
     *
     * @param \Datatrans\Client\Model\TransactionsError|null $error error
     *
     * @return self
     */
