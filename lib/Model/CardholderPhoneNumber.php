...
/**
 * CardholderPhoneNumber Class Doc Comment
 *
 * @category Class
 * @package  Datatrans\Client
 * @author   OpenAPI Generator team
 ...
 */
class CardholderPhoneNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CardholderPhoneNumber';
     ...
     * Sets subscriber
     *
     * @param string|null $subscriber subscriber
     *
     * @return self
     */
