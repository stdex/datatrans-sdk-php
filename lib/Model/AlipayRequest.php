 ...
 */
class AlipayRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayRequest';
    ...
    protected static $attributeMap = [
        ...
        'admission_notice_url' => 'admissionNoticeUrl',
    ...
    protected static $setters = [
        ...
        'admission_notice_url' => 'setAdmissionNoticeUrl',
        'goods_info' => 'setGoodsInfo',
        'total_quantity' => 'setTotalQuantity',
        'other_business_type' => 'setOtherBusinessType'
    ];
    ...
    protected static $getters = [
        ...
        'admission_notice_url' => 'getAdmissionNoticeUrl',
        'goods_info' => 'getGoodsInfo',
        'total_quantity' => 'getTotalQuantity',
        'other_business_type' => 'getOtherBusinessType'
    ];
    ...
    const BUSINESS_TYPE_HOTEL = 'Hotel';
    const BUSINESS_TYPE_AVIATION = 'Aviation';
    const BUSINESS_TYPE_OVERSEAS = 'Overseas';
    const BUSINESS_TYPE_EDUCATION = 'Education';
    const BUSINESS_TYPE_AFFAIRS = 'Affairs';
    const BUSINESS_TYPE_RETAILING = 'Retailing';
    ...
    {
        return [
            self::BUSINESS_TYPE_HOTEL,
            self::BUSINESS_TYPE_AVIATION,
            self::BUSINESS_TYPE_OVERSEAS,
            self::BUSINESS_TYPE_EDUCATION,
            self::BUSINESS_TYPE_AFFAIRS,
            self::BUSINESS_TYPE_RETAILING,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['checkin_time'] = $data['checkin_time'] ?? null;
        $this->container['checkout_time'] = $data['checkout_time'] ?? null;
        $this->container['flight_number'] = $data['flight_number'] ?? null;
        $this->container['departure_time'] = $data['departure_time'] ?? null;
        $this->container['admission_notice_url'] = $data['admission_notice_url'] ?? null;
        $this->container['goods_info'] = $data['goods_info'] ?? null;
        $this->container['total_quantity'] = $data['total_quantity'] ?? null;
        $this->container['other_business_type'] = $data['other_business_type'] ?? null;
    }
     ...
     * Sets business_type
     *
     * @param string|null $business_type Business type of the merchant.
     *
     * @return self
     */
     ...
     * Sets hotel_name
     *
     * @param string|null $hotel_name Name of the hotel. Mandatory when businessType is Hotel.
     *
     * @return self
     */
     ...
     * Sets checkin_time
     *
     * @param \DateTime|null $checkin_time Hotel checkin time. Mandatory when business type is Hotel. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return self
     */
     ...
     * Sets checkout_time
     *
     * @param \DateTime|null $checkout_time Hotel checkout time. Mandatory when business type is Hotel. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return self
     */
     ...
     * Sets flight_number
     *
     * @param string|null $flight_number Flight number, e.g. LX1234. Mandatory when businessType is Aviation.
     *
     * @return self
     */
     ...
     * Sets departure_time
     *
     * @param \DateTime|null $departure_time The flight departure time. Mandatory when businessType is Aviation. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return self
     */
    ...
    /**
     * Gets admission_notice_url
     *
     * @return string|null
     */
    public function getAdmissionNoticeUrl()
    {
        return $this->container['admission_notice_url'];
    }

    /**
     * Sets admission_notice_url
     *
     * @param string|null $admission_notice_url The picture address of admission notice.Mandatory when business type is [ Overseas | Education | Affairs ].
     *
     * @return self
     */
    public function setAdmissionNoticeUrl($admission_notice_url)
    {
        $this->container['admission_notice_url'] = $admission_notice_url;
    ...
    {
        return $this->container['goods_info'];
    }

    /**
     * Sets goods_info
     *
     * @param string|null $goods_info Goods information. Mandatory when business type is Retailing.
     *
     * @return self
     */
    public function setGoodsInfo($goods_info)
    {
        $this->container['goods_info'] = $goods_info;
     ...
     * Sets total_quantity
     *
     * @param int|null $total_quantity Quantities of goods. Mandatory when business type is Retailing.
     *
     * @return self
     */
    ...
    /**
     * Gets other_business_type
     *
     * @return string|null
     */
    public function getOtherBusinessType()
    {
        return $this->container['other_business_type'];
    }

    /**
     * Sets other_business_type
     *
     * @param string|null $other_business_type Name of business type. Mandatory when business type is Other.
     *
     * @return self
     */
    public function setOtherBusinessType($other_business_type)
    {
        $this->container['other_business_type'] = $other_business_type;
