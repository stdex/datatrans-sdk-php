...
class Installment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const RATE__3X3 = '3x3';
    const RATE__4X12 = '4x12';
    const RATE__12X12 = '12x12';
     ...
     * Sets rate
     *
     * @param string|null $rate The preferred rate model of the installment
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getRateAllowableValues();
        if (!is_null($rate) && !in_array($rate, $allowedValues, true)) {
