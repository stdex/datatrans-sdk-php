...
class Theme implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'configuration' => '\Datatrans\Client\Model\ThemeConfiguration'
    ];
     ...
     * Gets configuration
     *
     * @return \Datatrans\Client\Model\ThemeConfiguration|null
     */
     ...
     * Sets configuration
     *
     * @param \Datatrans\Client\Model\ThemeConfiguration|null $configuration configuration
     *
     * @return self
     */
