...
/**
 * MarketPlaceSplit Class Doc Comment
 *
 * @category Class
 ...
 */
class MarketPlaceSplit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarketPlaceSplit';
     ...
     *
     * @param string|null $sub_merchant_id Your sub-merchant's ID. This value is specified by your collector.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param int|null $amount The share of the transaction that you want to be transferred to / from a sub-merchant's account in the currency's smallest unit. For example use 1000 for CHF 10.00. The amount cannot be 0. The sum of all split amounts have to match the transaction amount.
     *
     * @return self
     */
