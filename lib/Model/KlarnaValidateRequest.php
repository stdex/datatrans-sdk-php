...
/**
 * KlarnaValidateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class KlarnaValidateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KlarnaValidateRequest';
